...
`||ct==="\r"?(te(),_=2):pt+=ct),_===3&&pt==="!--"&&(_=4,vt=vt[0])}return te(),vt})($)),k),arguments,[])).length>1?k:k[0]}var Et=Ht.bind(y),St={};function At($,k){for(var st in k)$[st]=k[st];return $}function Dt($,k,st){var ct,dt=/(?:\?([^#]*))?(#.*)?$/,_=$.match(dt),pt={};if(_&&_[1])for(var ee=_[1].split("&"),vt=0;vt<ee.length;vt++){var te=ee[vt].split("=");pt[decodeURIComponent(te[0])]=decodeURIComponent(te.slice(1).join("="))}$=Tt($.replace(dt,"")),k=Tt(k||"");for(var ne=Math.max($.length,k.length),Xt=0;Xt<ne;Xt++)if(k[Xt]&&k[Xt].charAt(0)===":"){var le=k[Xt].replace(/(^:|[+*?]+$)/g,""),ae=(k[Xt].match(/[+*?]+$/)||St)[0]||"",ce=~ae.indexOf("+"),ge=~ae.indexOf("*"),ve=$[Xt]||"";if(!ve&&!ge&&(ae.indexOf("?")<0||ce)){ct=!1;break}if(pt[le]=decodeURIComponent(ve),ce||ge){pt[le]=$.slice(Xt).map(decodeURIComponent).join("/");break}}else if(k[Xt]!==$[Xt]){ct=!1;break}return(st.default===!0||ct!==!1)&&pt}function Nt($,k){return $.rank<k.rank?1:$.rank>k.rank?-1:$.index-k.index}function Rt($,k){return $.index=k,$.rank=(function(st){return st.props.default?0:Tt(st.props.path).map(Mt).join("")})($),$.props}function Tt($){return $.replace(/(^\/+|\/+$)/g,"").split("/")}function Mt($){return $.charAt(0)==":"?1+"*+?".indexOf($.charAt($.length-1))||4:5}var Lt={},Wt=[],Ft=[],It=null,Vt={url:jt()},Ot=q(Vt);function jt(){var $;return""+(($=It&&It.location?It.location:It&&It.getCurrentLocation?It.getCurrentLocation():typeof location<"u"?location:Lt).pathname||"")+($.search||"")}function qt($,k){return k===void 0&&(k=!1),typeof $!="string"&&$.url&&(k=$.replace,$=$.url),(function(st){for(var ct=Wt.length;ct--;)if(Wt[ct].canRoute(st))return!0;return!1})($)&&(function(st,ct){ct===void 0&&(ct="push"),It&&It[ct]?It[ct](st):typeof history<"u"&&history[ct+"State"]&&history[ct+"State"](null,null,st)})($,k?"replace":"push"),Bt($)}function Bt($){for(var k=!1,st=0;st<Wt.length;st++)Wt[st].routeTo($)&&(k=!0);return k}function Kt($){if($&&$.getAttribute){var k=$.getAttribute("href"),st=$.getAttribute("target");if(k&&k.match(/^\//g)&&(!st||st.match(/^_?self$/i)))return qt(k)}}function zt($){return $.stopImmediatePropagation&&$.stopImmediatePropagation(),$.stopPropagation&&$.stopPropagation(),$.preventDefault(),!1}function Gt($){if(!($.ctrlKey||$.metaKey||$.altKey||$.shiftKey||$.button)){var k=$.target;do if(k.localName==="a"&&k.getAttribute("href")){if(k.hasAttribute("data-native")||k.hasAttribute("native"))return;if(Kt(k))return zt($)}while(k=k.parentNode)}}var Jt=!1;function Qt($){$.history&&(It=$.history),this.state={url:$.url||jt()}}At(Qt.prototype=new C,{shouldComponentUpdate:function($){return $.static!==!0||$.url!==this.props.url||$.onChange!==this.props.onChange},canRoute:function($){var k=A(this.props.children);return this.g(k,$)!==void 0},routeTo:function($){this.setState({url:$});var k=this.canRoute($);return this.p||this.forceUpdate(),k},componentWillMount:function(){this.p=!0},componentDidMount:function(){var $=this;Jt||(Jt=!0,It||addEventListener("popstate",(function(){Bt(jt())})),addEventListener("click",Gt)),Wt.push(this),It&&(this.u=It.listen((function(k){var st=k.location||k;$.routeTo(""+(st.pathname||"")+(st.search||""))}))),this.p=!1},componentWillUnmount:function(){typeof this.u=="function"&&this.u(),Wt.splice(Wt.indexOf(this),1)},componentWillUpdate:function(){this.p=!0},componentDidUpdate:function(){this.p=!1},g:function($,k){$=$.filter(Rt).sort(Nt);for(var st=0;st<$.length;st++){var ct=$[st],dt=Dt(k,ct.props.path,ct.props);if(dt)return[ct,dt]}},render:function($,k){var st,ct,dt=$.onChange,_=k.url,pt=this.c,ee=this.g(A($.children),_);if(ee&&(ct=j(ee[0],At(At({url:_,matches:st=ee[1]},st),{key:void 0,ref:void 0}))),_!==(pt&&pt.url)){At(Vt,pt=this.c={url:_,previous:pt&&pt.url,current:ct,path:ct?ct.props.path:null,matches:st}),pt.router=this,pt.active=ct?[ct]:[];for(var vt=Ft.length;vt--;)Ft[vt]({});typeof dt=="function"&&dt(pt)}return y(Ot.Provider,{value:pt},ct)}});const switchIcon="data:image/svg+xml,%3c?xml%20version='1.0'%20standalone='no'?%3e%3c!DOCTYPE%20svg%20PUBLIC%20'-//W3C//DTD%20SVG%2020010904//EN'%20'http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd'%3e%3csvg%20version='1.0'%20xmlns='http://www.w3.org/2000/svg'%20width='652.000000pt'%20height='956.000000pt'%20viewBox='0%200%20652.000000%20956.000000'%20preserveAspectRatio='xMidYMid%20meet'%3e%3cg%20transform='translate(0.000000,956.000000)%20scale(0.100000,-0.100000)'%20fill='%23000000'%20stroke='none'%3e%3cpath%20d='M1150%209540%20c-386%20-6%20-408%20-8%20-475%20-29%20-147%20-48%20-255%20-115%20-368%20-226%20-93%20-91%20-145%20-159%20-191%20-250%20-74%20-146%20-77%20-163%20-87%20-455%20-10%20-318%20-14%20-7639%20-4%20-7725%2025%20-214%20107%20-394%20245%20-539%20115%20-121%20227%20-192%20408%20-260%20l72%20-28%202418%20-1%20c2586%20-2%202582%20-2%202716%2047%20254%2092%20492%20346%20573%20611%2017%2058%2018%20211%2018%204095%20l0%204035%20-23%2075%20c-61%20193%20-204%20388%20-368%20501%20-76%2052%20-226%20118%20-294%20129%20-36%206%20-229%2015%20-430%2020%20-398%2010%20-3557%2010%20-4210%200z%20m4610%20-328%20c164%20-59%20291%20-175%20374%20-339%20l36%20-73%200%20-4016%200%20-4016%20-45%20-88%20c-25%20-48%20-70%20-115%20-101%20-148%20-64%20-71%20-175%20-148%20-242%20-168%20-103%20-32%20-400%20-35%20-2687%20-32%20-2180%203%20-2282%204%20-2335%2022%20-204%2068%20-363%20240%20-417%20452%20-17%2065%20-18%20275%20-18%203979%200%203785%201%203912%2019%203980%2024%2091%2084%20207%20140%20271%2055%2062%20182%20152%20244%20171%2027%208%20121%2018%20222%2022%2096%205%201203%208%202460%207%20l2285%20-1%2065%20-23z'/%3e%3cpath%20d='M1434%208128%20l-45%20-41%203%20-3291%20c3%20-3127%204%20-3293%2021%20-3323%209%20-18%2029%20-41%2044%20-50%2026%20-17%20125%20-18%201799%20-18%201918%200%201808%20-3%201834%2054%207%2014%2016%2067%2021%20116%205%2050%209%20789%209%201644%20l0%201554%20249%20981%20c358%201405%20401%201581%20401%201626%200%2051%204%2046%20-414%20468%20l-321%20322%20-1778%200%20-1777%200%20-46%20-42z%20m3636%20-425%20l165%20-168%20-185%20-6%20c-102%20-4%20-770%20-7%20-1485%20-8%20l-1300%20-1%20-145%20148%20c-80%2081%20-156%20159%20-170%20175%20l-23%2027%201489%200%201490%200%20164%20-167z%20m-3078%20-356%20l31%20-38%20-147%20-583%20c-81%20-320%20-153%20-602%20-160%20-626%20-12%20-39%20-13%20-23%20-19%20185%20-9%20291%20-9%20823%200%201123%20l6%20233%20129%20-128%20c71%20-70%20143%20-145%20160%20-166z%20m2900%20-136%20c278%20-3%20510%20-9%20513%20-13%2010%20-10%203%20-40%20-305%20-1260%20l-280%20-1107%200%20-1565%200%20-1566%20-1565%200%20-1565%200%200%201521%200%201520%20310%201226%20c171%20675%20313%201229%20316%201232%2014%2014%201788%2022%202576%2012z'/%3e%3cpath%20d='M3765%206820%20c-61%20-25%20-87%20-94%20-185%20-473%20-80%20-315%20-120%20-493%20-120%20-540%200%20-77%2078%20-141%20163%20-134%2069%206%20101%2040%20131%20141%2057%20190%20197%20746%20212%20843%205%2032%201%2053%20-19%2096%20-22%2048%20-30%2057%20-64%2066%20-44%2013%20-90%2013%20-118%201z'/%3e%3cpath%20d='M3098%203406%20c-104%20-37%20-216%20-134%20-264%20-227%20-24%20-47%20-28%20-71%20-35%20-184%20-19%20-311%20-7%20-500%2037%20-586%2040%20-80%20113%20-151%20201%20-195%20l76%20-39%20151%200%20151%200%2068%2034%20c81%2041%20167%20128%20215%20218%20l32%2061%200%20302%200%20302%20-41%2078%20c-65%20127%20-156%20201%20-284%20235%20-73%2019%20-255%2019%20-307%201z%20m262%20-311%20c58%20-30%2064%20-57%2068%20-301%204%20-219%204%20-222%20-19%20-253%20-65%20-88%20-230%20-95%20-286%20-13%20-16%2024%20-18%2055%20-21%20273%20l-3%20246%2038%2030%20c21%2017%2045%2033%2053%2036%2025%2011%20137%20-1%20170%20-18z'/%3e%3c/g%3e%3c/svg%3e",buttonIcon="data:image/svg+xml,%3c?xml%20version='1.0'%20standalone='no'?%3e%3c!DOCTYPE%20svg%20PUBLIC%20'-//W3C//DTD%20SVG%2020010904//EN'%20'http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd'%3e%3csvg%20version='1.0'%20xmlns='http://www.w3.org/2000/svg'%20width='171.000000pt'%20height='171.000000pt'%20viewBox='0%200%20171.000000%20171.000000'%20preserveAspectRatio='xMidYMid%20meet'%3e%3cg%20transform='translate(0.000000,171.000000)%20scale(0.100000,-0.100000)'%20fill='%23000000'%20stroke='none'%3e%3cpath%20d='M790%201280%20l0%20-420%2065%200%2065%200%200%20420%200%20420%20-65%200%20-65%200%200%20-420z'/%3e%3cpath%20d='M489%201612%20c-228%20-114%20-386%20-309%20-451%20-557%20-29%20-110%20-29%20-297%200%20-406%2081%20-301%20308%20-530%20607%20-610%20112%20-30%20307%20-30%20420%200%20294%2077%20529%20312%20606%20606%2029%20110%2030%20307%201%20416%20-67%20251%20-245%20462%20-477%20565%20l-55%2024%200%20-74%200%20-74%2072%20-42%20c280%20-167%20411%20-508%20313%20-817%20-35%20-110%20-88%20-196%20-175%20-283%20-87%20-87%20-172%20-139%20-285%20-177%20-70%20-23%20-96%20-27%20-210%20-27%20-114%200%20-140%204%20-210%2027%20-293%2097%20-495%20372%20-495%20673%200%2070%2025%20193%2055%20266%2054%20133%20182%20279%20299%20339%20l66%2034%200%2078%20c0%2042%20-1%2077%20-2%2077%20-2%200%20-37%20-18%20-79%20-38z'/%3e%3c/g%3e%3c/svg%3e",timerIcon="data:image/svg+xml,%3c?xml%20version='1.0'%20standalone='no'?%3e%3c!DOCTYPE%20svg%20PUBLIC%20'-//W3C//DTD%20SVG%2020010904//EN'%20'http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd'%3e%3csvg%20version='1.0'%20xmlns='http://www.w3.org/2000/svg'%20width='171.000000pt'%20height='171.000000pt'%20viewBox='0%200%20171.000000%20171.000000'%20preserveAspectRatio='xMidYMid%20meet'%3e%3cg%20transform='translate(0.000000,171.000000)%20scale(0.100000,-0.100000)'%20fill='%23000000'%20stroke='none'%3e%3cpath%20d='M818%201670%20c-24%20-15%20-31%20-77%20-23%20-221%208%20-141%2015%20-159%2064%20-159%2050%200%2060%2024%2063%20150%20l3%20115%2030%20-3%20c172%20-19%20366%20-132%20472%20-275%2094%20-129%20133%20-236%20140%20-392%206%20-142%20-12%20-230%20-73%20-355%20-82%20-165%20-236%20-296%20-419%20-357%20-71%20-24%20-95%20-27%20-215%20-27%20-118%200%20-145%203%20-212%2026%20-123%2041%20-204%2092%20-298%20187%20-68%2068%20-94%20103%20-127%20171%20-61%20125%20-76%20203%20-71%20352%206%20153%2036%20243%20122%20371%2064%2095%2068%20127%2021%20149%20-39%2017%20-68%202%20-113%20-59%20-94%20-127%20-150%20-285%20-159%20-449%20-23%20-399%20236%20-749%20632%20-855%20111%20-30%20297%20-30%20410%200%20449%20119%20716%20562%20610%201011%20-23%2095%20-105%20254%20-173%20336%20-111%20131%20-276%20234%20-442%20274%20-89%2021%20-213%2026%20-242%2010z'/%3e%3cpath%20d='M452%201258%20c-7%20-7%20-12%20-17%20-12%20-23%200%20-21%20330%20-469%20358%20-487%2043%20-28%20106%20-23%20143%2010%2043%2038%2052%20113%2020%20154%20-20%2025%20-454%20342%20-484%20354%20-7%202%20-18%20-1%20-25%20-8z'/%3e%3c/g%3e%3c/svg%3e",owIcon="data:image/svg+xml,%3c?xml%20version='1.0'%20standalone='no'?%3e%3c!DOCTYPE%20svg%20PUBLIC%20'-//W3C//DTD%20SVG%2020010904//EN'%20'http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd'%3e%3csvg%20version='1.0'%20xmlns='http://www.w3.org/2000/svg'%20width='110.000000pt'%20height='52.000000pt'%20viewBox='0%200%20110.000000%2052.000000'%20preserveAspectRatio='xMidYMid%20meet'%3e%3cg%20transform='translate(0.000000,52.000000)%20scale(0.100000,-0.100000)'%20fill='%23000000'%20stroke='none'%3e%3cpath%20d='M171%20500%20c-50%20-12%20-83%20-41%20-111%20-96%20-22%20-43%20-25%20-62%20-24%20-149%200%20-141%2027%20-199%20109%20-236%2073%20-33%20180%20-16%20227%2037%2067%2076%2074%20284%2013%20376%20-39%2059%20-133%2089%20-214%2068z%20m119%20-65%20c50%20-26%2065%20-67%2065%20-180%200%20-146%20-32%20-195%20-128%20-195%20-40%200%20-54%205%20-77%2028%20-16%2016%20-34%2049%20-40%2073%20-16%2056%20-7%20186%2014%20227%2030%2057%20105%2078%20166%2047z'/%3e%3cpath%20d='M482%20483%20c3%20-10%2029%20-120%2058%20-245%20l54%20-228%2038%200%20c43%200%2035%20-20%2089%20215%2017%2077%2035%20146%2038%20152%204%207%2026%20-73%2051%20-178%20l44%20-190%2039%203%2040%203%2058%20240%20c32%20132%2058%20241%2059%20243%200%202%20-15%202%20-32%200%20l-32%20-3%20-43%20-180%20c-23%20-99%20-44%20-187%20-46%20-195%20-2%20-8%20-25%2074%20-51%20183%20l-48%20198%20-36%20-3%20-36%20-3%20-45%20-194%20c-25%20-106%20-47%20-188%20-49%20-181%20-3%207%20-23%2095%20-46%20194%20l-42%20181%20-33%203%20c-28%203%20-33%201%20-29%20-15z'/%3e%3c/g%3e%3c/svg%3e",encoderIcon="data:image/svg+xml,%3c?xml%20version='1.0'%20standalone='no'?%3e%3c!DOCTYPE%20svg%20PUBLIC%20'-//W3C//DTD%20SVG%2020010904//EN'%20'http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd'%3e%3csvg%20version='1.0'%20xmlns='http://www.w3.org/2000/svg'%20width='34.000000pt'%20height='52.000000pt'%20viewBox='0%200%2034.000000%2052.000000'%20preserveAspectRatio='xMidYMid%20meet'%3e%3cg%20transform='translate(0.000000,52.000000)%20scale(0.100000,-0.100000)'%20fill='%23000000'%20stroke='none'%3e%3cpath%20d='M30%20255%20l0%20-245%20150%200%20150%200%200%2030%200%2030%20-115%200%20-115%200%200%2085%200%2085%2095%200%2095%200%200%2030%200%2030%20-95%200%20-95%200%200%2070%200%2070%20115%200%20115%200%200%2030%200%2030%20-150%200%20-150%200%200%20-245z'/%3e%3c/g%3e%3c/svg%3e",Icons={switchIcon:$=>Et`
  ...
  `}function ModalSwitch({modalType:$,page:k,hideModal:st,closeOnOverlayClick:ct=!0,title:dt,selectedSwitch:_,onSwitchChange:pt,connectionOptions:ee,SliderComponent:vt=MyPolzunok}){const[te,ne]=ut((_==null?void 0:_.info)||""),[Xt,le]=ut((_==null?void 0:_.onoff)||0),[ae,ce]=ut((_==null?void 0:_.ptype)||0),[ge,ve]=ut((_==null?void 0:_.setrpins)||""),[be,he]=ut([]);lt(()=>{fetch("/api/select/get",{method:"GET",cache:"no-store",headers:{"Content-Type":"application/json"}}).then(me=>{if(!me.ok)throw new Error(`HTTP error! status: ${me.status}`);return me.json()}).then(me=>{if(!me||!me.data||!Array.isArray(me.data)){console.error("Invalid data format:",me),he([]);return}const Ie=me.data.filter(ke=>ke.topin===2);he(Ie)}).catch(me=>{console.error("Error fetching pin config:",me),he([])})},[]);const fe=me=>{me.preventDefault();const Ie=new FormData(me.target),ke=Object.fromEntries(Ie);if(ke.id=_.id,ke.pins=_.pins,$==="edit")ke.onoff=Xt;else if($==="connection"){const $t=be.find(ht=>ht.pins===ke.setrpins);$t&&(ke.pinact={..._.pinact,[$t.id]:$t.pins})}fetch("/api/switch/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(ke)}).then($t=>$t.json()).then($t=>{console.log("Success:",$t),pt({..._,...ke}),st(),window.location.href="/#/switch"}).catch($t=>{console.error("Error:",$t)})},$e=me=>{ve(me.target.value)},Se=me=>{ce(parseInt(me.target.value))},_e=me=>{ne(me.target.value)},Pe=me=>{le(me)},de=me=>{ct&&me.target===me.currentTarget&&st()},xe=()=>{ce(0),ne(""),le(0)},we=Et`
    <div
...
Switch data: ${JSON.stringify(oe.switches,null,2)}`),console.log("Pintopin data:",Yt),console.log("Switch data:",oe.switches)}).catch(oe=>{console.error("Error fetching data:",oe),fe(`Error fetching data: ${oe.message}`)}),Pe=()=>{fetch("/api/switch/get").then(oe=>oe.json()).then(oe=>{ge(oe.switches),ae(oe.lang),console.log("Updated switch data:",oe.switches)}).catch(oe=>{console.error("Error fetching switch data:",oe)})},de=()=>{fetch("/api/pintopin/get").then(oe=>oe.json()).then(oe=>{be(oe),console.log("Updated pintopin data:",oe)}).catch(oe=>{console.error("Error fetching pintopin data:",oe)})};lt(()=>{Pe(),de();const oe=setInterval(()=>{Pe(),de()},1e3);return()=>clearInterval(oe)},[]);const xe=oe=>{const Yt=new Map,ie=ce.find(re=>re.id===oe);return ie&&ie.pinact&&Object.entries(ie.pinact).forEach(([re,ue])=>{Yt.set(re,{pin:re,relayId:ue})}),ve.forEach(re=>{if(re.idin===oe){const ue=`${re.pins}(${re.idout})`;Yt.has(ue)||Yt.set(ue,{pin:re.pins,relayId:re.idout})}}),Array.from(Yt.values())},Ee=()=>({langswitch:le==="ru"?ruLangswitch:enLangswitch}),we=(oe,Yt)=>{const ie=Ee(),ue=(ie[oe]&&ie[oe][Yt]||"").split(" "),ye=[];let mt="";for(let se=0;se<ue.length;se++){const pe=ue[se];mt.length+pe.length+1<=200?mt+=(mt.length>0?" ":"")+pe:(mt.length>0&&ye.push(mt),mt=pe)}return mt.length>0&&ye.push(mt),ye.join("<br>")},Te=(oe,Yt)=>{console.log("Удаление соединения:",oe,Yt);const[ie,re]=Yt.split("("),ue=re?parseInt(re):null;fetch("/api/connection/del",{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:oe,pin:ie.trim()})}).then(ye=>ye.json()).then(ye=>{ct(ye),ge(mt=>mt.map(se=>{if(se.id===oe){const pe={...se.pinact};return delete pe[ie.trim()],{...se,pinact:pe}}return se})),be(mt=>mt.filter(se=>!(se.idin===oe&&se.pins===ie.trim()&&(ue===null||se.idout===ue))))}).then(()=>{console.log("Соединение удалено успешно"),_e()}).catch(ye=>{console.error("Ошибка при удалении соединения:",ye)})},me=(oe,Yt)=>{ee(oe),te(Yt),_(!0)},Ie=()=>{_(!1),ee(null),te(null)},ke=oe=>{console.log("handleSwitchChange:",oe),fetch("/api/onoff/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:oe.id,onoff:oe.onoff})}).then(Yt=>Yt.json()).then(Yt=>{console.log("Response from /api/onoff/set:",Yt)}).catch(Yt=>{console.error("Error calling /api/onoff/set:",Yt)}),Ie()},$t={ru:Et`
  ...
  `,Zt=({d:oe,index:Yt})=>{const ie=xe(oe.id);return Et`
      <tr class="${Yt%2===1?"bg-white/80":"bg-sky-200/40"} hover:bg-slate-200/80 transition-colors">
        ...
        <td class="px-6 py-2 text-sm text-slate-700 font-mono">
          ${ie.map(({pin:re,relayId:ue})=>Et`
              <span class="mr-2 inline-flex items-center">
                ${re}${ue!==void 0?`(${ue})`:""}
                <button
                  onClick=${ye=>{ye.preventDefault(),Te(oe.id,`${re}(${ue})`)}}
            ...
            <div class="rounded-2xl bg-white/50 backdrop-blur-xl border border-white/60 shadow-inner w-full mb-6 overflow-auto">
              <div class="overflow-x-auto w-full">
                <table class="w-full text-left border-collapse whitespace-nowrap">
                  ...
                  <tbody class="divide-y divide-white/40">
                    ${ce.map((oe,Yt)=>Et`<${Zt} d=${oe} index=${Yt} key=${oe.id} />`)}
                  </tbody>
                </table>
              </div>
            </div>
  ...
  `,portalRef=at(null);return lt(()=>{const $=document.createElement("div");return $.id="modal-portal",document.body.appendChild($),portalRef.current=$,()=>{O(null,$),document.body.removeChild($)}},[]),lt(()=>{portalRef.current&&O(modalContent,portalRef.current)}),null};function initGlobalTooltip$6(){if(document.__tipInited)return;document.__tipInited=!0;const $=document.createElement("div");$.id="__global_tip",Object.assign($.style,{position:"fixed",zIndex:"99999",maxWidth:"280px",background:"#1a2332",color:"#e8f4f8",padding:"8px 12px",borderRadius:"8px",border:"1px solid rgba(0,188,188,0.35)",fontSize:"12px",lineHeight:"1.6",boxShadow:"0 6px 20px rgba(0,0,0,0.45)",pointerEvents:"none",whiteSpace:"normal",display:"none",transition:"opacity 0.12s ease",opacity:"0"}),document.body.appendChild($);let k=null;function st(dt){clearTimeout(k),$.innerHTML=dt.dataset.tip,$.style.display="block",$.style.opacity="0",$.style.left="0px",$.style.top="0px",requestAnimationFrame(()=>{const _=$.offsetWidth,pt=$.offsetHeight,ee=window.innerWidth,vt=dt.getBoundingClientRect();let te=vt.left+vt.width/2-_/2;te=Math.max(8,Math.min(te,ee-_-8));let ne=vt.top-pt-8;ne<8&&(ne=vt.bottom+8),$.style.left=te+"px",$.style.top=ne+"px",$.style.opacity="1"})}function ct(){k=setTimeout(()=>{$.style.opacity="0",setTimeout(()=>{$.style.display="none"},120)},80)}document.addEventListener("mouseover",dt=>{const _=dt.target.closest("[data-tip]");_&&st(_)}),document.addEventListener("mouseout",dt=>{dt.target.closest("[data-tip]")&&ct()})}const TabButton=()=>{const[$,k]=ut(null),[st,ct]=ut([]),[dt,_]=ut(null),[pt,ee]=ut(null),[vt,te]=ut(!1),[ne,Xt]=ut(null),[le,ae]=ut(null),[ce,ge]=ut(!1),[ve,be]=ut("ru"),[he,fe]=ut(""),[$e,Se]=ut(!0);lt(()=>{initGlobalTooltip$6()},[]);const _e={ru:Et`
    ...
    `},Pe=()=>{fetch("/api/button/get").then(ht=>ht.json()).then(ht=>{_(ht.buttons),be(ht.lang),console.log("Updated button data:",ht.buttons)}).catch(ht=>{console.error("Error fetching button data:",ht)})};lt(()=>{Pe();let ht;return $e&&(ht=setInterval(()=>{Pe()},1e3)),()=>{ht&&clearInterval(ht)}},[$e]);const de=ht=>{const Zt=new Map,oe=dt.find(Yt=>Yt.id===ht);return oe&&oe.pinact&&Object.entries(oe.pinact).forEach(([Yt,ie])=>{Zt.set(Yt,{pin:Yt,relayId:ie})}),st.forEach(Yt=>{if(Yt.idin===ht){const ie=`${Yt.pins}(${Yt.idout})`;Zt.has(ie)||Zt.set(ie,{pin:Yt.pins,relayId:Yt.idout})}}),Array.from(Zt.values())},xe=()=>({langbutton:ve==="ru"?rulangbutton:enlangbutton}),Ee=(ht,Zt)=>{const oe=xe(),Yt=oe[ht]&&oe[ht][Zt]?oe[ht][Zt]:"";return we(Yt)},we=(ht,Zt=100)=>{if(!ht||typeof ht!="string")return"";const oe=[];let Yt="";const ie=ht.split(`
`);return ie.forEach((re,ue)=>{re.split(" ").filter(mt=>mt.length>0).forEach(mt=>{const se=Yt.length===0?mt:" "+mt;Yt.length+se.length<=Zt?Yt+=se:(Yt.length>0&&oe.push(Yt),Yt=mt)}),Yt.length>0&&(oe.push(Yt),Yt=""),ue<ie.length-1&&oe.push("")}),Yt.length>0&&oe.push(Yt),oe.join(`
`)},Te=(ht,Zt)=>{Xt(ht),ae(Zt),te(!0),Se(!1)},me=()=>{te(!1),Xt(null),ae(null),Se(!0)},Ie=ht=>{console.log("handleButtonChange:",ht),_(Zt=>Zt.map(oe=>oe.id===ht.id?{...oe,...ht}:oe)),fetch("/api/onoff/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:ht.id,onoff:ht.onoff})}).then(Zt=>Zt.json()).then(Zt=>{console.log("Response from /api/onoff/set:",Zt)}).catch(Zt=>{console.error("Error calling /api/onoff/set:",Zt)}),me()},ke=ht=>Et`
    <th
      class="px-6 py-4 text-2xl font-bold text-slate-700 tracking-wide cursor-help"
  ...
  `,$t=({d:ht,index:Zt})=>(de(ht.id),Et`
            ...
            <div class="rounded-2xl bg-white/50 backdrop-blur-xl border border-white/60 shadow-inner w-full mb-6 overflow-auto">
              <div class="overflow-x-auto w-full">
                <table class="w-full text-left border-collapse whitespace-nowrap">
                  ...
                  <tbody class="divide-y divide-white/40">
                    ${dt.map((ht,Zt)=>Et`<${$t} d=${ht} index=${Zt} key=${ht.id} />`)}
                  </tbody>
                </table>
              </div>
            </div>
    ...
    ${vt&&Et`
        ...
        />
      `}
  `:""};function ModalEncoder({modalType:$,page:k,hideModal:st,closeOnOverlayClick:ct=!0,title:dt,selectedEncoder:_,handleEncoderChange:pt,connectionOptions:ee,SliderComponent:vt=MyPolzunok}){const[te,ne]=ut((_==null?void 0:_.info)||""),[Xt,le]=ut((_==null?void 0:_.onoff)===1),[ae,ce]=ut({pin:(_==null?void 0:_.encdrbpin)||"",id:(_==null?void 0:_.encoderb)||""}),[ge,ve]=ut(Object.entries(_.pinact||{})[0]||["",""]),[be,he]=ut([]),[fe,$e]=ut([]),[Se,_e]=ut([]),Pe=_.pwmmax||100,[de,xe]=ut(_.dvalue||0),[Ee,we]=ut(_.ponr||0),[Te,me]=ut(_.pwm||1e7),Ie=se=>Math.round(se*Pe/100);lt(()=>{fetch("/api/select/get",{method:"GET",cache:"no-store",headers:{"Content-Type":"application/json"}}).then(se=>{if(!se.ok)throw new Error(`HTTP error! status: ${se.status}`);return se.json()}).then(se=>{if(!se||!se.data||!Array.isArray(se.data)){console.error("Invalid data format:",se),he([]),$e([]),_e([]);return}const pe=se.data.filter(Me=>Me.topin===2),Ce=se.data.filter(Me=>Me.topin===9),Oe=se.data.filter(Me=>Me.topin===5);if(he(pe),$e(Ce),_e(Oe),_.encoderb||_.encdrbpin){const Me=Ce.find(Ne=>String(Ne.id)===String(_.encoderb)||Ne.pins===_.encdrbpin);ce({pin:Me?Me.pins:"",id:Me?Me.id:""})}}).catch(se=>{console.error("Error fetching pin config:",se),he([]),$e([]),_e([])})},[_]);const ke=se=>{if(se.preventDefault(),!(se.target instanceof HTMLFormElement))return;let Ce={};if($==="edit")Ce={topin:8,id:_.id,pins:_.pins,pwm:parseInt(Te),pwmmax:_.pwmmax,dvalue:parseInt(de),ponr:parseInt(Ee),info:te,onoff:Xt?1:0};else if($==="connection"){const Me=ge&&ge[0]&&ge[1]!==void 0?{[ge[0]]:parseInt(ge[1])}:{};Ce={id:_.id,pins:_.pins,pwm:parseInt(Te)},ae&&ae.id!==void 0&&ae.id!==""?(Ce.encoderb=parseInt(ae.id),Ce.encdrbpin=ae.pin):(Ce.encoderb=255,Ce.encdrbpin=""),Ce.pinact=Me}console.log("Sending JSON to STM32:",JSON.stringify(Ce)),fetch("/api/encoder/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(Ce)}).then(Oe=>Oe.json()).then(Oe=>{pt({..._,...Ce}),st()}).catch(Oe=>console.error("Error saving encoder:",Oe))},$t=se=>{ne(se.target.value)},ht=se=>{le(se)},Zt=se=>{const pe=fe.find(Ce=>Ce.pins===se.target.value);ce({pin:se.target.value,id:pe?pe.id:""})},oe=se=>{if(!se.target.value)ve(["",""]);else{const pe=se.target.value.split("|");ve([pe[0],pe[1]])}},Yt=se=>{xe(se.target.value)},ie=se=>{we(se.target.value)},re=se=>{const pe=se/1e3;return pe<=4e4?{cls:"text-green-600",msg:"Optimal range"}:pe<=2e5?{cls:"text-yellow-600",msg:"Precision might drop"}:{cls:"text-red-600",msg:"Expert mode: low precision"}},ye=Et`
    <div
      class="fixed inset-0 z-[999] bg-black bg-opacity-50 flex items-center justify-center p-4"
                ...
                <tbody>
                  ...
                  <tr class="bg-gray-200">
                    ...
                    <td class="p-2">
                      <select
                        name="encdrb"
                        value=${fe.some(se=>se.pins===ae.pin)?ae.pin:""}
                        onchange=${Zt}
                        class="border rounded p-2 w-full"
                      >
                  ...
                  <tr class="bg-white">
                    ...
                    <td class="p-2">
                      <select
                        name="pwmconnection"
                        value=${Se.some(se=>String(se.pins)===String(ge[0]))?`${ge[0]}|${ge[1]}`:""}
                        onchange=${oe}
                        class="border rounded p-2 w-full"
                      >
                        <option value="">Select PWM connection</option>
                        ${Se.map(se=>{const pe=pwmTimerMap[se.pins]||"Unknown Timer";return Et`
  ...
  `,mt=at(null);return lt(()=>{const se=document.createElement("div");return se.id="encoder-modal-portal",document.body.appendChild(se),mt.current=se,()=>{O(null,se),document.body.removeChild(se)}},[]),lt(()=>{mt.current&&O(ye,mt.current)}),null}function initGlobalTooltip$5(){if(document.__tipInited)return;document.__tipInited=!0;const $=document.createElement("div");$.id="__global_tip",Object.assign($.style,{position:"fixed",zIndex:"99999",maxWidth:"280px",background:"#1a2332",color:"#e8f4f8",padding:"8px 12px",borderRadius:"8px",border:"1px solid rgba(0,188,188,0.35)",fontSize:"12px",lineHeight:"1.6",boxShadow:"0 6px 20px rgba(0,0,0,0.45)",pointerEvents:"none",whiteSpace:"normal",display:"none",transition:"opacity 0.12s ease",opacity:"0"}),document.body.appendChild($);let k=null;function st(dt){clearTimeout(k),$.innerHTML=dt.dataset.tip,$.style.display="block",$.style.opacity="0",$.style.left="0px",$.style.top="0px",requestAnimationFrame(()=>{const _=$.offsetWidth,pt=$.offsetHeight,ee=window.innerWidth,vt=dt.getBoundingClientRect();let te=vt.left+vt.width/2-_/2;te=Math.max(8,Math.min(te,ee-_-8));let ne=vt.top-pt-8;ne<8&&(ne=vt.bottom+8),$.style.left=te+"px",$.style.top=ne+"px",$.style.opacity="1"})}function ct(){k=setTimeout(()=>{$.style.opacity="0",setTimeout(()=>{$.style.display="none"},120)},80)}document.addEventListener("mouseover",dt=>{const _=dt.target.closest("[data-tip]");_&&st(_)}),document.addEventListener("mouseout",dt=>{dt.target.closest("[data-tip]")&&ct()})}const pwmTimerMap={PA0:"TIM2",PA3:"TIM2",PB10:"TIM2",PA6:"TIM3",PB1:"TIM3",PB15:"TIM12",PC6:"TIM8",PC7:"TIM8",PC8:"TIM8",PC9:"TIM8",PD12:"TIM4",PD13:"TIM4",PD14:"TIM4",PD15:"TIM4",PE5:"TIM9",PE6:"TIM9",PE9:"TIM1",PE11:"TIM1",PE13:"TIM1",PE14:"TIM1",PF6:"TIM10",PF7:"TIM11",PF8:"TIM13",PF9:"TIM14"};function TabEncoder({}){{const[$,k]=ut(null),[st,ct]=ut(null),[dt,_]=ut(!1),[pt,ee]=ut(null),[vt,te]=ut(null),[ne,Xt]=ut(!1),[le,ae]=ut("ru"),[ce,ge]=ut([]),ve=at(!1);lt(()=>{initGlobalTooltip$5()},[]);const be=()=>Promise.all([fetch("/api/encoder/get").then(ht=>ht.json()),fetch("/api/pintopin/get").then(ht=>ht.json())]).then(([ht,Zt])=>{ae(ht.lang),k(ht.encoders),ge(Zt),console.log("Encoder data:",ht.encoders),console.log("Pintopin data:",Zt)}).catch(ht=>{console.error("Error fetching data:",ht)}),he=()=>{fetch("/api/encoder/get").then(ht=>ht.json()).then(ht=>{if(ve.current){console.log("Polling skip: onoff request in flight");return}k(ht.encoders),ae(ht.lang),console.log("Updated encoder data:",ht.encoders)}).catch(ht=>{console.error("Error fetching encoder data:",ht)})},fe=()=>{fetch("/api/pintopin/get").then(ht=>ht.json()).then(ht=>{ge(ht),console.log("Updated pintopin data:",ht)}).catch(ht=>{console.error("Error fetching pintopin data:",ht)})};lt(()=>{he(),fe();const ht=setInterval(()=>{he(),fe()},500);return()=>clearInterval(ht)},[]);const $e=ht=>{k(Zt=>Zt.map(oe=>oe.id===ht.id?ht:oe)),ve.current=!0,fetch("/api/onoff/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:ht.id,onoff:ht.onoff})}).then(Zt=>Zt.json()).then(Zt=>{console.log("Response from /api/onoff/set (Encoder):",Zt)}).catch(Zt=>{console.error("Error calling /api/onoff/set (Encoder):",Zt)}).finally(()=>{ve.current=!1})},Se=ht=>{const Zt=$.find(Yt=>Yt.id===ht),oe=[];return Zt&&Zt.pinact&&Object.entries(Zt.pinact).forEach(([Yt,ie])=>{oe.push({pin:Yt,idout:ie})}),oe},_e=ht=>{const Zt=ht/1e3;return Zt<=4e4?{cls:"text-green-600",msg:"✓"}:Zt<=2e5?{cls:"text-yellow-600",msg:"~"}:{cls:"text-red-600",msg:"!"}},Pe=ht=>{if(!ht)return"—";const Zt=ht/1e3;return Zt>=1e6?`${(Zt/1e6).toFixed(2)} MHz`:Zt>=1e3?`${(Zt/1e3).toFixed(1)} kHz`:`${Zt} Hz`},de=()=>({langbutton:le==="ru"?ruencoder:enencoder}),xe=(ht,Zt)=>{const oe=de(),Yt=oe[ht]&&oe[ht][Zt]?oe[ht][Zt]:"";return Ee(Yt)},Ee=(ht,Zt=50)=>{if(!ht||typeof ht!="string")return"";const oe=ht.split(" ");let Yt=[],ie="";for(let re=0;re<oe.length;re++)ie.length+oe[re].length+1<=Zt?ie+=`${ie?" ":""}${oe[re]}`:(ie&&Yt.push(ie.trim()),ie=oe[re]);return ie&&Yt.push(ie.trim()),Yt.join(`
`)},we=(ht,Zt)=>{console.log("Deleting connection:",ht,Zt);const oe=Zt.split("(")[0].trim();fetch("/api/connection/del",{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:ht,pin:oe})}).then(Yt=>Yt.ok?Yt.json():Yt.text().then(ie=>{throw new Error(`HTTP error! status: ${Yt.status}, message: ${ie}`)})).then(Yt=>{ct(Yt),k(ie=>ie.map(re=>{if(re.id===ht){const ue={...re.pinact};return delete ue[oe],{...re,pinact:ue}}return re})),ge(ie=>ie.filter(re=>!(re.idin===ht&&re.pins===oe)))}).then(()=>{console.log("Connection deleted successfully"),be()}).catch(Yt=>{console.error("Error deleting connection:",Yt)})},Te=(ht,Zt)=>{console.log("Opening modal:",ht,Zt),ee(ht),te(Zt),_(!0)},me=()=>{_(!1),ee(null),te(null)},Ie={ru:Et`
        <div class="mytext space-y-6">
          <div>
            <pre class="mb-4">
      ...
      `},ke=({title:ht,tooltipIndex:Zt})=>Et`
      <th
        class="px-6 py-4 text-2xl font-bold text-slate-700 tracking-wide cursor-help"
        data-tip=${xe("langbutton",Zt)}
      >
        ${ht}
      </th>
    `,$t=({d:ht,index:Zt})=>{const oe=Se(ht.id),Yt=_e(ht.pwm||0),ie=oe.map(re=>pwmTimerMap[re.pin]).filter((re,ue,ye)=>re&&ye.indexOf(re)===ue);return Et`
        <tr class="${Zt%2===1?"bg-white/80":"bg-sky-200/40"} hover:bg-slate-200/80 transition-colors">
          ...
          <td class="px-6 py-2 text-sm text-slate-700 font-mono">
            ${oe.length>0?oe.map(({pin:re,idout:ue})=>Et`
                    <span class="mr-2 inline-flex items-center">
                      ${re}(${ue})
                      <button
                        onClick=${ye=>{ye.preventDefault(),we(ht.id,`${re}(${ue})`)}}
                        class="ml-1 text-red-500 hover:text-red-700 transition-colors font-bold"
                        title="Remove connection"
                      >
                        [x]
              ...
              <div class="rounded-2xl bg-white/50 backdrop-blur-xl border border-white/60 shadow-inner w-full mb-6 overflow-auto">
                <div class="overflow-x-auto w-full">
                  <table class="w-full text-left border-collapse whitespace-nowrap">
                    <thead>
                      <tr class="bg-teal-600/10 border-b border-teal-600/20">
                        <${ke} title="Encoder A (ID)" tooltipIndex=${3} />
                        <${ke} title="Encoder B (ID)" tooltipIndex=${4} />
                        <${ke} title="PWM connection" tooltipIndex=${5} />
                        <${ke} title="PWM Frequency" tooltipIndex=${11} />
                        <${ke} title="Resolution (steps)" tooltipIndex=${12} />
                        <${ke} title="Dimmer value (0-100)" tooltipIndex=${6} />
                        <${ke} title="Duty on restore" tooltipIndex=${7} />
                        <${ke} title="INFO" tooltipIndex=${8} />
                        <${ke} title="On/Off" tooltipIndex=${9} />
                        <${ke} title="Action" tooltipIndex=${10} />
                      </tr>
                    </thead>
                    <tbody id="tab1" class="divide-y divide-white/40">
                      ${$.map((ht,Zt)=>Et`<${$t} d=${ht} index=${Zt} key=${ht.id} />`)}
                    </tbody>
                  </table>
                </div>
              </div>
  ...
  `,we=at(null);return lt(()=>{const Te=document.createElement("div");return Te.id="modal-portal",document.body.appendChild(Te),we.current=Te,()=>{O(null,Te),document.body.removeChild(Te)}},[]),lt(()=>{we.current&&O(Ee,we.current)}),null}function ModalPwmCron({modalType:$,page:k,hideModal:st,closeOnOverlayClick:ct=!0,title:dt,selectedCron:_,handleCronChange:pt,modalClass:ee,SliderComponent:vt=MyPolzunok}){let te="",ne="900",Xt="0",le="100";if(_!=null&&_.activ&&_.activ.startsWith("pwm:")){const ht=_.activ.substring(4).split(",");ht.length===4&&(te=ht[0],ne=ht[1],Xt=ht[2],le=ht[3])}const[ae,ce]=ut((_==null?void 0:_.info)||""),[ge,ve]=ut((_==null?void 0:_.onoff)===1),[be,he]=ut((_==null?void 0:_.cron)||""),[fe,$e]=ut(te),[Se,_e]=ut(ne),[Pe,de]=ut(Xt),[xe,Ee]=ut(le),[we,Te]=ut([]);lt(()=>{fetch("/api/select/get",{method:"GET",cache:"no-store"}).then(ht=>ht.json()).then(ht=>{if(ht&&ht.data&&Array.isArray(ht.data)){const Zt=ht.data.filter(oe=>oe.topin===5);Te(Zt),!fe&&Zt.length>0&&$e(Zt[0].id.toString())}}).catch(ht=>console.error("Error fetching pin config:",ht))},[]);const me=ht=>{ht.preventDefault();const Zt=new FormData(ht.target),oe=Object.fromEntries(Zt);oe.id=_.id,oe.pins=_.pins,oe.onoff=ge?1:0,oe.info=ae,oe.cron=be,oe.activ=`pwm:${fe},${Se},${Pe},${xe}`,fetch("/api/cron/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(oe)}).then(Yt=>Yt.json()).then(Yt=>{pt({..._,...oe}),st(),window.location.href="/#/cron"}).catch(Yt=>console.error("Error:",Yt))},Ie=()=>Et`
      <form onsubmit=${me}>
        <div class="modal-body">
          <table class="table-auto w-full">
            <tbody>
  ...
  `,ke=({d:$t,index:ht})=>{const Zt=$t.activ&&$t.activ.startsWith("pwm:");let oe=$t.activ;if(Zt){const Yt=$t.activ.substring(4).split(",");Yt.length===4&&(oe=`pwmID=${Yt[0]} | ${Yt[1]}s | ${Yt[2]}%→${Yt[3]}%`)}return Et`
                ...
                <div class="rounded-2xl bg-white/50 backdrop-blur-xl border border-white/60 shadow-inner w-full mb-6 overflow-auto">
                  <div class="overflow-x-auto w-full">
                    <table class="w-full text-left border-collapse whitespace-nowrap">
                      ...
                      <tbody class="divide-y divide-white/40">
                        ${$.slice(0,ce).map(($t,ht)=>Et`<${ke} d=${$t} index=${ht} key=${$t.id} />`)}
                      </tbody>
                    </table>
                  </div>
                </div>
  ...
  `}const PRESETS$1={ru:[{value:"1",label:"Паяльная станция T max=125°C, T min=-55°C"},{value:"2",label:"Кулер / вентилятор T max=70°C, T min=-55°C"},{value:"3",label:"3D‑принтер (стол) T max=120°C, T min=0°C"},{value:"4",label:"Форточный нагреватель T max=60°C, T min=-55°C"},{value:"5",label:"Тёплый пол T max=45°C, T min=0°C"},{value:"6",label:"Холодильник T max=100°C, T min=-55°C"},{value:"7",label:"Аквариум / бойлер T max=80°C, T min=0°C"},{value:"8",label:"Инкубатор T max=45°C, T min=0°C"},{value:"9",label:"Теплица / комната T max=50°C, T min=-55°C"}],en:[{value:"1",label:"Soldering station T max=125°C, T min=-55°C"},{value:"2",label:"Cooler / fan T max=70°C, T min=-55°C"},{value:"3",label:"3D printer (table) T max=120°C, T min=0°C"},{value:"4",label:"Vent heater T max=60°C, T min=-55°C"},{value:"5",label:"Warm floor T max=45°C, T min=0°C"},{value:"6",label:"Refrigerator T max=100°C, T min=-55°C"},{value:"7",label:"Aquarium / boiler T max=80°C, T min=0°C"},{value:"8",label:"Incubator T max=45°C, T min=0°C"},{value:"9",label:"Greenhouse / room T max=50°C, T min=-55°C"}]},SENSOR_OPTIONS$1=[{value:"1",label:"DS18B20"},{value:"2",label:"DHT-22"}];function ModalPid({modalType:$,page:k,hideModal:st,closeOnOverlayClick:ct=!0,title:dt,selectedPid:_,handlePidChange:pt,language:ee="en",modalClass:vt,SliderComponent:te=MyPolzunok}){const[ne,Xt]=ut((_==null?void 0:_.info)||""),[le,ae]=ut((_==null?void 0:_.onoff)===1),[ce,ge]=ut((_==null?void 0:_.selsens)||"1"),[ve,be]=ut((_==null?void 0:_.sernum)||""),[he,fe]=ut((_==null?void 0:_.presets)||"1"),[$e,Se]=ut((_==null?void 0:_.tmpset)||""),[_e,Pe]=ut((_==null?void 0:_.tmpcur)||""),[de,xe]=ut([]),[Ee,we]=ut(Object.entries((_==null?void 0:_.pinact)||{})[0]||["",""]);lt(()=>{Xt((_==null?void 0:_.info)||""),ae((_==null?void 0:_.onoff)===1),ge((_==null?void 0:_.selsens)||"1"),be((_==null?void 0:_.sernum)||""),fe((_==null?void 0:_.presets)||"1"),Se((_==null?void 0:_.tmpset)||""),Pe((_==null?void 0:_.tmpcur)||""),we(Object.entries((_==null?void 0:_.pinact)||{})[0]||["",""])},[_]),lt(()=>{fetch("/api/select/get",{method:"GET",cache:"no-store",headers:{"Content-Type":"application/json"}}).then(Zt=>{if(!Zt.ok)throw new Error(`HTTP error! status: ${Zt.status}`);return Zt.json()}).then(Zt=>{if(!Zt||!Zt.data||!Array.isArray(Zt.data)){console.error("Invalid data format:",Zt),xe([]);return}const oe=Zt.data.filter(Yt=>Yt.topin===5);xe(oe)}).catch(Zt=>{console.error("Error fetching pin config:",Zt),xe([])})},[_]);const Te=Zt=>{Zt.preventDefault();const oe=Ee[0]&&Ee[1]!==void 0&&Ee[1]!=="",Yt={id:_.id,pins:Ee[0],pinact:oe?{[Ee[0]]:parseInt(Ee[1])}:{},selsens:ce,sernum:ve,presets:he,tmpset:$e,tmpcur:_e,info:ne,onoff:le?1:0};console.log("Data being sent to server:",Yt),fetch("/api/pid/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(Yt)}).then(ie=>ie.json()).then(ie=>{console.log("Success:",ie),pt({..._,...Yt}),st(),window.location.href="/#/pid"}).catch(ie=>{console.error("Error:",ie)})},me=Zt=>{if(!Zt.target.value)we(["",""]);else{const oe=Zt.target.value.split("|");we([oe[0],oe[1]])}},Ie=PRESETS$1[ee]||PRESETS$1.en,ke=()=>k==="TabPid"&&$==="edit"?Et`
        <form onsubmit=${Te}>
          <div class="modal-body">
            <table class="table-auto w-full">
              <tbody>
                ${[{label:"ID",value:_.id},{label:"PWM Pin",value:Et`
                        <select
                          value=${de.some(Zt=>String(Zt.pins)===String(Ee[0]))?`${Ee[0]}|${Ee[1]}`:""}
                          onChange=${me}
                          class="border rounded p-2 w-full"
                        >
                      ...
                      <select
                        value=${ce}
                        onChange=${Zt=>ge(Zt.target.value)}
                        class="border rounded p-2 w-full"
                      >
                        ${SENSOR_OPTIONS$1.map(Zt=>Et`
                            <option
                              value=${Zt.value}
                              selected=${Zt.value===ce}
                            >
                              ${Zt.label}
                            </option>
                          `)}
                    ...
                    `},{label:"Dev. ser. number",value:ce==="1"?Et`
                      ...
                      <select
                        value=${he}
                        onChange=${Zt=>fe(Zt.target.value)}
                        class="border rounded p-2 w-full"
                      >
                        ${Ie.map(Zt=>Et`
                            <option
                              value=${Zt.value}
                              selected=${Zt.value===he}
                            >
                              ${Zt.label}
                            </option>
                          `)}
...
First, select the «PWM pin» parameter. Then specify the type of temperature sensor: DS18B20 or DHT22. After that, select one of the available presets that closely matches the required temperature and timing parameters. Finally, set the target temperature that the PID controller should maintain.
  ...
  `,document.head.appendChild($)}function TabPid({}){const[$,k]=ut(null),[st,ct]=ut(null);at(null);const[dt,_]=ut(!1),[pt,ee]=ut(null),[vt,te]=ut(null),[ne,Xt]=ut("ru"),[le,ae]=ut(!1),[ce,ge]=ut(0),[ve,be]=ut(0),he=at(!1);lt(()=>{initGlobalTooltip$3(),initTuneStyles()},[]);const fe=()=>{fetch("/api/pid/get").then(Yt=>Yt.json()).then(Yt=>{he.current||Yt&&Array.isArray(Yt.pid)&&(k(Yt.pid),Xt(Yt.lang||"ru"),typeof Yt.pidline=="number"&&(be(Yt.pidline),ge(Yt.pidline)))}).catch(Yt=>console.error("Error fetching PID data:",Yt))};lt(()=>{fe();const Yt=setInterval(()=>{fe()},500);return()=>clearInterval(Yt)},[]);const $e=at(!0);lt(()=>{if($e.current){$e.current=!1;return}Se(ve)},[ve]);const Se=Yt=>{fetch("/api/pidline/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({pidline:Yt})}).then(ie=>ie.json()).then(ie=>console.log("Pidline sent to stm32:",ie)).catch(ie=>console.error("Error sending PID line to stm32:",ie))},_e=()=>{if(ce<PID_MAX_SLOTS){const Yt=ce+1;ge(Yt),be(Yt)}},Pe=()=>{if(ce>0){const Yt=ce-1;ge(Yt),be(Yt)}};if($===null)return Et`<div>Loading...</div>`;const de=()=>({langtimers:ne==="ru"?rulangtimers:enlangtimers}),xe=(Yt,ie)=>{const re=de(),ye=(re[Yt]&&re[Yt][ie]?re[Yt][ie]:"").split(" "),mt=[];for(let se=0;se<ye.length;se+=15)mt.push(ye.slice(se,se+15).join(" "));return mt.join("<br>")},Ee=(Yt,ie)=>{ee(Yt),te(ie),_(!0)},we=()=>{_(!1),ee(null),te(null)},Te=Yt=>{console.log("handlePidChange:",Yt),k($.map(ie=>ie.id===Yt.id?Yt:ie)),he.current=!0,fetch("/api/pid/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(Yt)}).then(ie=>ie.json()).then(ie=>{console.log("PID job updated successfully:",ie)}).catch(ie=>{console.error("Error updating PID job:",ie)}).finally(()=>{he.current=!1})},me=Yt=>{const ie=Yt.id,re=Yt.tune_state||0;if(!(re===TUNE_STEP||re===TUNE_BIAS)){if(re===TUNE_ERROR){Ie(ie);return}console.log("Run tune for id:",ie),fetch("/api/pid/tune",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:ie,action:"start"})}).then(ue=>ue.json()).then(ue=>{console.log("Tune start response:",ue)}).catch(ue=>{console.error("Error starting tune:",ue)})}},Ie=Yt=>{console.log("Stop tune for id:",Yt),fetch("/api/pid/tune",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:Yt,action:"stop"})}).then(ie=>ie.json()).then(ie=>{console.log("Tune stop response:",ie)}).catch(ie=>{console.error("Error stopping tune:",ie)})},ke=PRESETS[ne]||PRESETS.en,$t=Yt=>{const ie=ke.find(re=>re.value===String(Yt));return ie?ie.label:Yt},ht=Yt=>{const ie=SENSOR_OPTIONS.find(re=>re.value===String(Yt));return ie?ie.label:Yt},Zt=Yt=>Et`
    <th
      class="px-4 py-4 text-base font-bold text-slate-700 tracking-wide cursor-help"
      data-tip=${xe("langtimers",Yt.tooltipIndex)}
    >
      ${Yt.title}
    </th>
  `,oe=(Yt,ie)=>{const re=Yt.tune_state||0,ue=Yt.tune_progress||0,ye=re===TUNE_STEP||re===TUNE_BIAS,mt=re===TUNE_DONE,se=re===TUNE_ERROR,pe=mt?"background:linear-gradient(to right,#4ade80,#10b981);box-shadow:0 4px 14px rgba(16,185,129,0.4);":se?"background:linear-gradient(to right,#dc2626,#b91c1c);box-shadow:0 4px 14px rgba(220,38,38,0.5);animation:tuneBlink 1s ease-in-out infinite;":"background:linear-gradient(to right,#ef4444,#e11d48);box-shadow:0 4px 14px rgba(239,68,68,0.4);",Ce="px-3 py-1 rounded-full text-sm font-bold text-white transition-all duration-300 transform hover:scale-105 active:scale-95 whitespace-nowrap",Oe=mt?"Tuning Done":se?"⚠ Error!":"Run tune";if(ye){const Me=ue.toFixed(1),Le=`Auto Tune (${re===TUNE_STEP?"Step test":"Bias search"})… ${ue}%`;return Et`
        <tr key=${Yt.id} class="${ie%2===1?"bg-white/80":"bg-sky-200/40"}">
      ...
      `}return Et`
      <tr key=${Yt.id} class="${ie%2===1?"bg-white/80":"bg-sky-200/40"} hover:bg-slate-200/80 transition-colors">
        <td class="px-4 py-3 text-sm text-slate-800 font-medium">${Yt.id}</td>
        <td class="px-4 py-3 text-sm text-slate-700 font-mono">
          ${(()=>{const Me=Object.entries(Yt.pinact||{});if(!Me.length)return"—";const[Ne,Le]=Me[0];return`${Ne}(${Le})`})()}
        </td>
        ...
        <td class="px-4 py-3 text-sm text-slate-700">${$t(Yt.presets)}</td>
              ...
              <div class="rounded-2xl bg-white/50 backdrop-blur-xl border border-white/60 shadow-inner w-full mb-6 overflow-auto">
                <div class="overflow-x-auto w-full">
                  <table class="w-full text-left border-collapse whitespace-nowrap">
                    ...
                    <tbody class="divide-y divide-white/40">
                      ${Array.from({length:ce},(Yt,ie)=>{const re=$&&$[ie]?$[ie]:{id:ie+1,pins:"",pinact:{},selsens:"",sernum:"",presets:"",tmpset:"",tmpcur:"",info:"",onoff:0,tune_state:0,tune_progress:0};return oe(re,ie)})}
                    </tbody>
                  </table>
                </div>
              </div>
  ...
  `}function ModalEditSensor({typsensor:$,oneWireId:k,pins:st,onClose:ct,onUpdate:dt,sensorType:_,sensorData:pt,closeOnOverlayClick:ee=!0}){const[vt,te]=ut({ut:(pt==null?void 0:pt.ut)||$.ut,lt:(pt==null?void 0:pt.lt)||$.lt,action_ut:(pt==null?void 0:pt.action_ut)||$.action_ut,action_lt:(pt==null?void 0:pt.action_lt)||$.action_lt,upphumid:(pt==null?void 0:pt.upphumid)||$.upphumid||0,humlolim:(pt==null?void 0:pt.humlolim)||$.humlolim||0,actuphum:(pt==null?void 0:pt.actuphum)||$.actuphum||"",actlowhum:(pt==null?void 0:pt.actlowhum)||$.actlowhum||"",info:(pt==null?void 0:pt.info)||$.info,onoff:(pt==null?void 0:pt.onoff)||$.onoff||0,humidity:(pt==null?void 0:pt.humidity)||$.humidity||0}),[ne,Xt]=ut(!1),le=(fe,$e,Se)=>{if(fe===""||fe==="-")return fe;const _e=fe.replace(",",".");if(!/^-?\d*\.?\d*$/.test(_e))return null;const Pe=parseFloat(_e);return isNaN(Pe)||Pe<$e||Pe>Se?null:_e},ae=fe=>{const{name:$e,value:Se}=fe.target;if(["ut","lt"].includes($e)){const _e=le(Se,-55,125);_e!==null&&te(Pe=>({...Pe,[$e]:_e}))}else if(["upphumid","humlolim"].includes($e)){const _e=le(Se,0,100);_e!==null&&te(Pe=>({...Pe,[$e]:_e}))}else te(_e=>({..._e,[$e]:Se}))},ce=fe=>{const $e=["ut","lt","upphumid","humlolim"],Se={...fe};return $e.forEach(_e=>{Se[_e]===""||Se[_e]==="-"?Se[_e]=0:Se[_e]=parseFloat(Se[_e].toString().replace(",","."))}),Se},be=Et`
    <div
      class="fixed inset-0 z-[999] bg-black bg-opacity-50 flex items-center justify-center p-4"
  ...
  `},TabOneWire=()=>{const[$,k]=ut([]),[st,ct]=ut(null),[dt,_]=ut(!1),[pt,ee]=ut(null),[vt,te]=ut(null),[ne,Xt]=ut("ru"),[le,ae]=ut(null),[ce,ge]=ut(!1),[ve,be]=ut({}),he=$t=>be(ht=>({...ht,[$t]:!ht[$t]})),fe=$t=>typeof $t=="string"?$t.replace(/[^\x20-\x7E\u0400-\u04FF]/g,""):$t;lt(()=>{initGlobalTooltip$2()},[]);const $e=()=>{console.log("Calling initial refresh..."),fetch("/api/onewire/get").then($t=>$t.json()).then($t=>{console.log("Initial data received:",$t),Xt($t.lang||"ru"),k($t.pins||[]),console.log("Initial OneWire state set:",$t.pins),ct(null)}).catch($t=>{console.error("Error in refresh:",$t),ct($t.message),k([])})},Se=async()=>{try{const ht=await(await fetch("/api/temp/get")).json();k(Zt=>Zt.map(oe=>{if(!oe.sensors||oe.typsensor!==1&&oe.typsensr!==1&&oe.typsensor!==2&&oe.typsensr!==2)return oe;const Yt=oe.sensors.map(ie=>{var re,ue;if(oe.typsensor===1||oe.typsensr===1){const ye=(re=ht.ds18b20)==null?void 0:re.find(mt=>mt.addr===ie.s_number);if(ye)return{...ie,t:ye.temp}}else if(oe.typsensor===2||oe.typsensr===2){const ye=(ue=ht.dht22)==null?void 0:ue.find(mt=>mt.id===oe.id);if(ye)return{...ie,t:ye.temp,humidity:ye.humidity}}return ie});return{...oe,sensors:Yt}}))}catch($t){console.error("Error in updateSensorData:",$t)}};lt(()=>{console.log("Setting up initial data and interval..."),$e();const $t=setInterval(Se,1e3);return()=>{clearInterval($t)}},[]);const _e=()=>{_(!1),ee(null),te(null)},Pe=$t=>{k(ht=>ht.map(Zt=>{var oe;if(Zt.id===$t.oneWireId){const Yt=((oe=Zt.sensors)==null?void 0:oe.map(ie=>ie.s_number===$t.s_number?{...ie,...$t}:ie))||[];return{...Zt,sensors:Yt}}return Zt})),_e()},de=$t=>{te($t),_(!0)},xe=$t=>{k(ht=>ht.map(Zt=>Zt.id===$t.id?{...Zt,onoff:$t.onoff}:Zt))},Ee=$t=>{k(ht=>ht.map(Zt=>Zt.id===$t.id?$t:Zt)),_e()};if(st)return Et`<div>Error fetching sensor data: ${st}</div>`;const we=()=>({lang1Wire:ne==="ru"?rulange1Wire:enlange1Wire}),Te=($t,ht)=>{const Zt=we(),Yt=(Zt[$t]&&Zt[$t][ht]?Zt[$t][ht]:"").split(" "),ie=[];for(let re=0;re<Yt.length;re+=15)ie.push(Yt.slice(re,re+15).join(" "));return ie.join("<br>")},me=$t=>Et`
    <th
      class="px-6 py-4 text-2xl font-bold text-slate-700 tracking-wide cursor-help"
  ...
  `,Ie=({device:$t,index:ht})=>{const Zt=!!ve[$t.id],oe=$t.pins||$t.pin,Yt=$t.typsensor||$t.typsensr||0,ie=$t.numdevices||$t.numsens||0,re=Yt!==0&&ie>0;return Et`
      <tbody key=${"db-"+$t.id}>
        <tr
          class="${ht%2===1?"bg-white/80":"bg-sky-200/40"} hover:bg-slate-200/80 transition-colors ${re?"cursor-pointer":""}"
          onclick=${()=>re&&he($t.id)}
        >
          <td class="px-6 py-4 text-sm text-slate-800 font-medium">${$t.id}</td>
    ...
    `},ke=({d:$t})=>{const ht=$t.typsensor||$t.typsensr||0,Zt=$t.numdevices||$t.numsens||0;if(ht===0||Zt===0)return Et`
        <div class="px-4 py-2 text-slate-500 font-medium">
          No connected sensors for this OneWire pin.
        </div>
      `;let oe=$t.sensors||[];const Yt=["bg-cyan-50/60 border-cyan-200/50","bg-slate-100/70 border-slate-200/50"],ie=(re,ue)=>{const ye=ht===2,mt=fe(re.s_number)||"",se=pe=>{if(pe.stopPropagation(),!mt)return;const Ce=pe.currentTarget,Oe=Me=>{Ce.textContent=Me?"Copied!":"Error",setTimeout(()=>{Ce.textContent="copy SN"},1500)};if(navigator.clipboard&&window.isSecureContext){navigator.clipboard.writeText(mt).then(()=>Oe(!0)).catch(()=>Oe(!1));return}try{const Me=document.createElement("textarea");Me.value=mt,Me.style.cssText="position:fixed;top:-9999px;left:-9999px;opacity:0;",document.body.appendChild(Me),Me.focus(),Me.select();const Ne=document.execCommand("copy");document.body.removeChild(Me),Oe(Ne)}catch{Oe(!1)}};return Et`
        <div class="w-full flex flex-wrap items-center gap-x-3 gap-y-2 px-4 py-3
                    rounded-xl border ${Yt[ue%2]}
          ...
          ${re.info?Et`
            <span class="text-slate-300 select-none text-base">|</span>
            <span class="text-sm text-slate-500 italic" title=${re.info}>
              ${re.info}
            </span>
          `:""}
          ...
          <a
            ...
            onclick=${pe=>{pe.preventDefault(),ee({...re,oneWireId:$t.id,sensorType:ht,pins:$t.pins||$t.pin}),_(!0)}}
          >Edit</a>
        </div>
      `};return oe.length>0&&Object.keys(oe[0]).length>0?Et`<div class="flex flex-col gap-2 w-full">${oe.map((re,ue)=>ie(re,ue))}</div>`:Et`
  ...
  `,ve=at(null);return lt(()=>{const be=document.createElement("div");return be.id="modal-portal",document.body.appendChild(be),ve.current=be,()=>{O(null,be),document.body.removeChild(be)}},[]),lt(()=>{ve.current&&O(ge,ve.current)}),null}const ModalSecurity=({modalType:$,page:k,hideModal:st,title:ct,selectedSecurity:dt,onSecurityChange:_,SliderComponent:pt=MyPolzunok})=>{const[ee,vt]=ut((dt==null?void 0:dt.info)||""),[te,ne]=ut((dt==null?void 0:dt.onoff)||0),[Xt,le]=ut((dt==null?void 0:dt.ptype)||0),[ae,ce]=ut((dt==null?void 0:dt.send_sms)||""),[ge,ve]=ut((dt==null?void 0:dt.action)||""),[be,he]=ut([]),[fe,$e]=ut({send_sms:null,action:null}),[Se,_e]=ut(null),Pe=/^(None|\d{1,2}:[012])(,\d{1,2}:[012])*$/,de=($t,ht)=>!ht||ht.trim()===""||ht.toLowerCase()==="none"?null:$t==="action"?Pe.test(ht)?null:'Incorrect format. Use "None" or "pin:value" format.':ht.length>100?"Text should not exceed 100 characters":null,xe=($t,ht)=>{const Zt=de($t,ht);switch($e(oe=>({...oe,[$t]:Zt})),$t){case"send_sms":ce(ht);break;case"action":ve(ht);break}};lt(()=>{fetch("/api/monitoring/get").then($t=>$t.json()).then($t=>{Array.isArray($t)?he($t.filter(ht=>ht.topin===2)):he([])}).catch($t=>{console.error("Error fetching pin config:",$t),he([])})},[]);const Ee=$t=>{if($t.preventDefault(),Object.values(fe).some(Zt=>Zt!==null)){_e("Please correct the errors before submitting.");return}const ht={...dt,info:ee,send_sms:ae||"NO",action:ge||"None",onoff:te,ptype:Xt};fetch("/api/monitoring/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(ht)}).then(Zt=>{if(!Zt.ok)throw new Error("Network response was not ok");return Zt.json()}).then(Zt=>{if(Zt.error)throw new Error(Zt.error);_(ht),st()}).catch(Zt=>{console.error("Error:",Zt),_e("Failed to save changes. Please try again.")})},we=()=>{le(0),ce(""),ve(""),vt(""),ne(0),$e({send_sms:null,action:null})},Ie=Et`
    <div
      class="fixed inset-0 z-[999] bg-black bg-opacity-50"
      style="margin-top: 7px;"
    >
  ...
  `,ke=at(null);return lt(()=>{const $t=document.createElement("div");return $t.id="modal-portal",document.body.appendChild($t),ke.current=$t,()=>{O(null,$t),document.body.removeChild($t)}},[]),lt(()=>{ke.current&&O(Ie,ke.current)}),null};function initGlobalTooltip$1(){if(document.__tipInited)return;document.__tipInited=!0;const $=document.createElement("div");$.id="__global_tip",Object.assign($.style,{position:"fixed",zIndex:"99999",maxWidth:"280px",background:"#1a2332",color:"#e8f4f8",padding:"8px 12px",borderRadius:"8px",border:"1px solid rgba(0,188,188,0.35)",fontSize:"12px",lineHeight:"1.6",boxShadow:"0 6px 20px rgba(0,0,0,0.45)",pointerEvents:"none",whiteSpace:"normal",display:"none",transition:"opacity 0.12s ease",opacity:"0"}),document.body.appendChild($);let k=null;function st(dt){clearTimeout(k),$.innerHTML=dt.dataset.tip,$.style.display="block",$.style.opacity="0",$.style.left="0px",$.style.top="0px",requestAnimationFrame(()=>{const _=$.offsetWidth,pt=$.offsetHeight,ee=window.innerWidth,vt=dt.getBoundingClientRect();let te=vt.left+vt.width/2-_/2;te=Math.max(8,Math.min(te,ee-_-8));let ne=vt.top-pt-8;ne<8&&(ne=vt.bottom+8),$.style.left=te+"px",$.style.top=ne+"px",$.style.opacity="1"})}function ct(){k=setTimeout(()=>{$.style.opacity="0",setTimeout(()=>{$.style.display="none"},120)},80)}document.addEventListener("mouseover",dt=>{const _=dt.target.closest("[data-tip]");_&&st(_)}),document.addEventListener("mouseout",dt=>{dt.target.closest("[data-tip]")&&ct()})}const TabSecurity=()=>{const[$,k]=ut({lang:"ru",sim800l:0,onoff:0,tel:"",info:""}),[st,ct]=ut(!1),[dt,_]=ut(!1),[pt,ee]=ut([]),[vt,te]=ut(!1),[ne,Xt]=ut("ru"),[le,ae]=ut(!1),[ce,ge]=ut(""),[ve,be]=ut(null),[he,fe]=ut(!1),[$e,Se]=ut("connected"),[_e,Pe]=ut(0);lt(()=>{initGlobalTooltip$1()},[]);const de=()=>ne==="ru"?ruLangsecurity:enLangsecurity,xe=()=>ne==="ru"?ruLangsecuritypins:enLangsecuritypins,Ee=(ue,ye)=>{const se=(ue&&ue[ye]?ue[ye]:"").split(" "),pe=[];for(let Ce=0;Ce<se.length;Ce+=15)pe.push(se.slice(Ce,Ce+15).join(" "));return pe.join("<br>")},we=({title:ue,langArr:ye,tooltipIndex:mt})=>Et`
    <th
      class="px-6 py-4 text-2xl font-bold text-slate-700 tracking-wide cursor-help"
      data-tip=${Ee(ye,mt)}
    >
  ...
  `,Te=(ue,ye)=>{let mt;return(...se)=>{clearTimeout(mt),mt=setTimeout(()=>ue(...se),ye)}},me=async(ue,ye={},mt=3)=>{try{const se=await fetch(ue,ye);if(!se.ok)throw new Error("Network response was not ok");return Se("connected"),se}catch(se){if(Se("error"),mt>0)return await new Promise(pe=>setTimeout(pe,1e3)),me(ue,ye,mt-1);throw Se("disconnected"),se}},Ie={ru:Et`
      <div class="mytext space-y-6">
        <div>
    ...
    <div class="flex flex-col items-center w-full p-4 mb-16">
      <div class="flex flex-col items-center w-full p-6 bg-white/40 backdrop-blur-md rounded-2xl shadow-xl border border-white/50 relative overflow-hidden">
        ...
        <div class="w-full mb-6 px-2 flex flex-row items-center gap-6">
          ...
          <select
            value=${$.lang}
            onChange=${mt=>re("lang",mt.target.value)}
                      ...
                      <th class="px-6 py-4 text-2xl font-bold text-slate-700 tracking-wide" colspan="2">
                        <div class="flex items-center gap-3">
                          ...
                          <div class="network-toggle">
                            <${MyPolzunok} value=${$.check_ip} onChange=${mt=>re("check_ip",mt)} />
                          </div>
                  ...
                  <thead>
                    <tr class="bg-teal-600/10 border-b border-teal-600/20">
                      <th class="px-6 py-4 text-2xl font-bold text-slate-700 tracking-wide w-1/3">
                        <div class="flex items-center gap-3">
                          <span>MQTT</span>
                          <${MyPolzunok} value=${$.check_mqtt} onChange=${mt=>re("check_mqtt",mt)} />
                        </div>
                      </th>
                      <th class="px-6 py-4 text-2xl font-bold text-slate-700 tracking-wide w-2/3">Value</th>
                    </tr>
                  ...
                  <thead>
                    <tr class="bg-teal-600/10 border-b border-teal-600/20">
                      <th class="px-6 py-4 text-2xl font-bold text-slate-700 tracking-wide w-1/3">
                        <div class="flex items-center gap-3">
                          <span>HTTPS</span>
                          <${MyPolzunok} value=${$.usehttps} onChange=${mt=>re("usehttps",mt)} />
                        </div>
                      </th>
                      <th class="px-6 py-4 text-2xl font-bold text-slate-700 tracking-wide w-2/3">Value</th>
                    </tr>
                      ...
                      <div class="relative w-full">
                        ${mt.type==="textarea"?Et`
                            ${mt.key==="tls_key"&&$.tls_key?Et`<div class="w-full px-3 py-2 bg-white/40 border border-white/50 rounded-lg text-slate-600 font-medium shadow-inner">Данные введены, но информация скрыта!</div>`:mt.key==="tls_cert"&&$.tls_cert?Et`<div class="w-full px-3 py-2 bg-white/40 border border-white/50 rounded-lg text-slate-600 font-medium shadow-inner">Данные введены успешно!</div>`:Et`<textarea
                                    name=${mt.key}
                                    value=${$[mt.key]||""}
                                    onInput=${pe=>re(mt.key,pe.target.value)}
                                    class=${`w-full px-3 py-2 bg-white/50 border ${pt[mt.key]?"border-red-500 ring-2 ring-red-500/50":"border-white/50"} rounded-lg shadow-inner focus:outline-none focus:ring-2 focus:ring-cyan-500`}
                                    rows="1"
          ...
          <div class="w-full mb-6">
            <div class="w-full overflow-auto rounded-2xl shadow-lg border border-white/50 bg-white/30 backdrop-blur-sm">
              ...
              <${FieldRow} label="Longitude" tip=${xe("Longitude")} index=${0}>
                <${pageSetting} value=${$.lon_de} setfn=${mt=>re("lon_de",mt)} type="text"
              ...
              <${FieldRow} label="Latitude" tip=${xe("Latitude")} index=${1}>
                <${pageSetting} value=${$.lat_de} setfn=${mt=>re("lat_de",mt)} type="text"
              ...
              <tr class="transition-colors border-b border-slate-200 bg-white/80 hover:bg-slate-200/80">
                ...
                <td class="w-2/3 pl-4 py-4 pr-6">
                  <div class="flex items-center gap-4">
                    <${MyPolzunok} value=${$.onsunrise} onChange=${mt=>re("onsunrise",mt)} />
                    <input type="text" value=${$.sunrise_pins||""} onInput=${mt=>re("sunrise_pins",mt.target.value)}
              ...
              <tr class="transition-colors border-b border-slate-200 bg-sky-200/40 hover:bg-slate-200/80">
                ...
                <td class="w-2/3 pl-4 py-4 pr-6">
                  <div class="flex items-center gap-4">
                    <${MyPolzunok} value=${$.onsunset} onChange=${mt=>re("onsunset",mt)} />
                    <input type="text" value=${$.sunset_pins||""} onInput=${mt=>re("sunset_pins",mt.target.value)}
          ...
          <div class="w-full mb-6">
            <div class="w-full overflow-auto rounded-2xl shadow-lg border border-white/50 bg-white/30 backdrop-blur-sm">
              ...
              <tr class="transition-colors border-b border-slate-200 bg-white/80 hover:bg-slate-200/80">
                ...
                <td class="w-2/3 pl-4 py-4 pr-6">
                  <input type="text" name="offdate" value=${$.offdate||""} onInput=${mt=>re("offdate",mt.target.value)}
              ...
              <tr class="transition-colors border-b border-slate-200 bg-sky-200/40 hover:bg-slate-200/80">
                ...
                <td class="w-2/3 pl-4 py-4 pr-6">
                  <input type="text" name="offtime" value=${$.offtime||""} onInput=${mt=>re("offtime",mt.target.value)}
  ...
  </svg>`;function Header({logout:$,user:k,setShowSidebar:st,showSidebar:ct}){const[dt,_]=ut(new Date),[pt,ee]=ut(null),vt=(le,ae)=>new Date(le.year+1900,le.mon,le.mday,le.hour,le.min,le.sec),te=async()=>{try{const ae=await(await fetch("/api/stm32-time")).text();let ce;try{ce=JSON.parse(ae)}catch{return}ce.status&&ce.time?ee(vt(ce.time,ce.timezone)):ee(null)}catch{ee(null)}};lt(()=>{const le=setInterval(()=>_(new Date),1e3),ae=setInterval(te,1e3);return te(),()=>{clearInterval(le),clearInterval(ae)}},[]);const ne=le=>le.toLocaleDateString("ru-RU",{day:"2-digit",month:"2-digit",year:"numeric"}),Xt=le=>le.toLocaleTimeString("ru-RU");return Et`
    <div
...
/>
  ...
  <//>`}function Chart({data:$}){const k=$.length,st=20,ct=15,dt=100,_=5,pt=10,ee=25,vt=le=>(dt-pt)/_*(le+1),te=le=>(dt-pt)*le/100,ne=le=>dt-pt-te(le),Xt=(le,ae,ce)=>Array.from({length:ae},(ge,ve)=>ve*1+le);return Et` <div
  ...
  `}function FirmwareUpdate({}){const[$,k]=ut([{},{}]),[st,ct]=ut(null),dt=()=>fetch("api/firmware/status").then(le=>le.json()).then(le=>k(le));lt(dt,[]),lt(()=>{if(st){const le=setTimeout(()=>{ct(null)},3e3);return()=>clearTimeout(le)}},[st]);const _=le=>fetch("api/firmware/commit").then(ae=>ae.json()).then(dt),pt=le=>fetch("api/reboot",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({reboot:1})}).then(ae=>ae.json()).then(ae=>new Promise(ce=>setTimeout(()=>{dt(),ce()},5e3))),ee=le=>fetch("api/firmware/rollback").then(pt),vt=le=>fetch("api/device/eraselast").then(dt),te=function(le){if(!le){ct({type:"yellow",message:"Error: No file selected."});return}const ae=le.name.split(".").pop().toLowerCase();if(ae!=="bin"&&ae!=="hex"){ct({type:"red",message:"Error: Only .bin and .hex files are allowed!"});return}const ce=new FormData;ce.append("file",le),fetch("api/firmware/upload",{method:"POST",body:ce}).then(ge=>{if(!ge.ok)throw new Error(`HTTP error! status: ${ge.status}`);return ge.json()}).then(()=>{ct({type:"green",message:"Firmware uploaded successfully!"}),dt()}).catch(ge=>{ct({type:"yellow",message:`Error: Upload failed. ${ge.message}`})})},ne=({type:le,message:ae})=>Et`
      <div
    ...
    `,Xt=({title:le,onupload:ae})=>Et`
      ...
      >
        ...
        <input
          ...
          class="hidden"
          accept=".bin,.hex"
          onChange=${ge=>{const ve=ge.target.files[0];ve&&ae(ve)}}
        />
      </label>
    `;return Et`
