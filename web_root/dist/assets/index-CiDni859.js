...
`||dt==="\r"?(oe(),st=2):pt+=dt),st===3&&pt==="!--"&&(st=4,vt=vt[0])}return oe(),vt})($)),_),arguments,[])).length>1?_:_[0]}var Et=Ht.bind(y),St={};function At($,_){for(var k in _)$[k]=_[k];return $}function Dt($,_,k){var dt,ct=/(?:\?([^#]*))?(#.*)?$/,st=$.match(ct),pt={};if(st&&st[1])for(var Yt=st[1].split("&"),vt=0;vt<Yt.length;vt++){var oe=Yt[vt].split("=");pt[decodeURIComponent(oe[0])]=decodeURIComponent(oe.slice(1).join("="))}$=Tt($.replace(ct,"")),_=Tt(_||"");for(var le=Math.max($.length,_.length),ht=0;ht<le;ht++)if(_[ht]&&_[ht].charAt(0)===":"){var Zt=_[ht].replace(/(^:|[+*?]+$)/g,""),ne=(_[ht].match(/[+*?]+$/)||St)[0]||"",he=~ne.indexOf("+"),xe=~ne.indexOf("*"),ge=$[ht]||"";if(!ge&&!xe&&(ne.indexOf("?")<0||he)){dt=!1;break}if(pt[Zt]=decodeURIComponent(ge),he||xe){pt[Zt]=$.slice(ht).map(decodeURIComponent).join("/");break}}else if(_[ht]!==$[ht]){dt=!1;break}return(k.default===!0||dt!==!1)&&pt}function Nt($,_){return $.rank<_.rank?1:$.rank>_.rank?-1:$.index-_.index}function Rt($,_){return $.index=_,$.rank=(function(k){return k.props.default?0:Tt(k.props.path).map(Mt).join("")})($),$.props}function Tt($){return $.replace(/(^\/+|\/+$)/g,"").split("/")}function Mt($){return $.charAt(0)==":"?1+"*+?".indexOf($.charAt($.length-1))||4:5}var Lt={},Wt=[],Ft=[],It=null,Vt={url:jt()},Ot=q(Vt);function jt(){var $;return""+(($=It&&It.location?It.location:It&&It.getCurrentLocation?It.getCurrentLocation():typeof location<"u"?location:Lt).pathname||"")+($.search||"")}function qt($,_){return _===void 0&&(_=!1),typeof $!="string"&&$.url&&(_=$.replace,$=$.url),(function(k){for(var dt=Wt.length;dt--;)if(Wt[dt].canRoute(k))return!0;return!1})($)&&(function(k,dt){dt===void 0&&(dt="push"),It&&It[dt]?It[dt](k):typeof history<"u"&&history[dt+"State"]&&history[dt+"State"](null,null,k)})($,_?"replace":"push"),Bt($)}function Bt($){for(var _=!1,k=0;k<Wt.length;k++)Wt[k].routeTo($)&&(_=!0);return _}function Kt($){if($&&$.getAttribute){var _=$.getAttribute("href"),k=$.getAttribute("target");if(_&&_.match(/^\//g)&&(!k||k.match(/^_?self$/i)))return qt(_)}}function zt($){return $.stopImmediatePropagation&&$.stopImmediatePropagation(),$.stopPropagation&&$.stopPropagation(),$.preventDefault(),!1}function Gt($){if(!($.ctrlKey||$.metaKey||$.altKey||$.shiftKey||$.button)){var _=$.target;do if(_.localName==="a"&&_.getAttribute("href")){if(_.hasAttribute("data-native")||_.hasAttribute("native"))return;if(Kt(_))return zt($)}while(_=_.parentNode)}}var Jt=!1;function Qt($){$.history&&(It=$.history),this.state={url:$.url||jt()}}At(Qt.prototype=new C,{shouldComponentUpdate:function($){return $.static!==!0||$.url!==this.props.url||$.onChange!==this.props.onChange},canRoute:function($){var _=A(this.props.children);return this.g(_,$)!==void 0},routeTo:function($){this.setState({url:$});var _=this.canRoute($);return this.p||this.forceUpdate(),_},componentWillMount:function(){this.p=!0},componentDidMount:function(){var $=this;Jt||(Jt=!0,It||addEventListener("popstate",(function(){Bt(jt())})),addEventListener("click",Gt)),Wt.push(this),It&&(this.u=It.listen((function(_){var k=_.location||_;$.routeTo(""+(k.pathname||"")+(k.search||""))}))),this.p=!1},componentWillUnmount:function(){typeof this.u=="function"&&this.u(),Wt.splice(Wt.indexOf(this),1)},componentWillUpdate:function(){this.p=!0},componentDidUpdate:function(){this.p=!1},g:function($,_){$=$.filter(Rt).sort(Nt);for(var k=0;k<$.length;k++){var dt=$[k],ct=Dt(_,dt.props.path,dt.props);if(ct)return[dt,ct]}},render:function($,_){var k,dt,ct=$.onChange,st=_.url,pt=this.c,Yt=this.g(A($.children),st);if(Yt&&(dt=j(Yt[0],At(At({url:st,matches:k=Yt[1]},k),{key:void 0,ref:void 0}))),st!==(pt&&pt.url)){At(Vt,pt=this.c={url:st,previous:pt&&pt.url,current:dt,path:dt?dt.props.path:null,matches:k}),pt.router=this,pt.active=dt?[dt]:[];for(var vt=Ft.length;vt--;)Ft[vt]({});typeof ct=="function"&&ct(pt)}return y(Ot.Provider,{value:pt},dt)}});const switchIcon="data:image/svg+xml,%3c?xml%20version='1.0'%20standalone='no'?%3e%3c!DOCTYPE%20svg%20PUBLIC%20'-//W3C//DTD%20SVG%2020010904//EN'%20'http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd'%3e%3csvg%20version='1.0'%20xmlns='http://www.w3.org/2000/svg'%20width='652.000000pt'%20height='956.000000pt'%20viewBox='0%200%20652.000000%20956.000000'%20preserveAspectRatio='xMidYMid%20meet'%3e%3cg%20transform='translate(0.000000,956.000000)%20scale(0.100000,-0.100000)'%20fill='%23000000'%20stroke='none'%3e%3cpath%20d='M1150%209540%20c-386%20-6%20-408%20-8%20-475%20-29%20-147%20-48%20-255%20-115%20-368%20-226%20-93%20-91%20-145%20-159%20-191%20-250%20-74%20-146%20-77%20-163%20-87%20-455%20-10%20-318%20-14%20-7639%20-4%20-7725%2025%20-214%20107%20-394%20245%20-539%20115%20-121%20227%20-192%20408%20-260%20l72%20-28%202418%20-1%20c2586%20-2%202582%20-2%202716%2047%20254%2092%20492%20346%20573%20611%2017%2058%2018%20211%2018%204095%20l0%204035%20-23%2075%20c-61%20193%20-204%20388%20-368%20501%20-76%2052%20-226%20118%20-294%20129%20-36%206%20-229%2015%20-430%2020%20-398%2010%20-3557%2010%20-4210%200z%20m4610%20-328%20c164%20-59%20291%20-175%20374%20-339%20l36%20-73%200%20-4016%200%20-4016%20-45%20-88%20c-25%20-48%20-70%20-115%20-101%20-148%20-64%20-71%20-175%20-148%20-242%20-168%20-103%20-32%20-400%20-35%20-2687%20-32%20-2180%203%20-2282%204%20-2335%2022%20-204%2068%20-363%20240%20-417%20452%20-17%2065%20-18%20275%20-18%203979%200%203785%201%203912%2019%203980%2024%2091%2084%20207%20140%20271%2055%2062%20182%20152%20244%20171%2027%208%20121%2018%20222%2022%2096%205%201203%208%202460%207%20l2285%20-1%2065%20-23z'/%3e%3cpath%20d='M1434%208128%20l-45%20-41%203%20-3291%20c3%20-3127%204%20-3293%2021%20-3323%209%20-18%2029%20-41%2044%20-50%2026%20-17%20125%20-18%201799%20-18%201918%200%201808%20-3%201834%2054%207%2014%2016%2067%2021%20116%205%2050%209%20789%209%201644%20l0%201554%20249%20981%20c358%201405%20401%201581%20401%201626%200%2051%204%2046%20-414%20468%20l-321%20322%20-1778%200%20-1777%200%20-46%20-42z%20m3636%20-425%20l165%20-168%20-185%20-6%20c-102%20-4%20-770%20-7%20-1485%20-8%20l-1300%20-1%20-145%20148%20c-80%2081%20-156%20159%20-170%20175%20l-23%2027%201489%200%201490%200%20164%20-167z%20m-3078%20-356%20l31%20-38%20-147%20-583%20c-81%20-320%20-153%20-602%20-160%20-626%20-12%20-39%20-13%20-23%20-19%20185%20-9%20291%20-9%20823%200%201123%20l6%20233%20129%20-128%20c71%20-70%20143%20-145%20160%20-166z%20m2900%20-136%20c278%20-3%20510%20-9%20513%20-13%2010%20-10%203%20-40%20-305%20-1260%20l-280%20-1107%200%20-1565%200%20-1566%20-1565%200%20-1565%200%200%201521%200%201520%20310%201226%20c171%20675%20313%201229%20316%201232%2014%2014%201788%2022%202576%2012z'/%3e%3cpath%20d='M3765%206820%20c-61%20-25%20-87%20-94%20-185%20-473%20-80%20-315%20-120%20-493%20-120%20-540%200%20-77%2078%20-141%20163%20-134%2069%206%20101%2040%20131%20141%2057%20190%20197%20746%20212%20843%205%2032%201%2053%20-19%2096%20-22%2048%20-30%2057%20-64%2066%20-44%2013%20-90%2013%20-118%201z'/%3e%3cpath%20d='M3098%203406%20c-104%20-37%20-216%20-134%20-264%20-227%20-24%20-47%20-28%20-71%20-35%20-184%20-19%20-311%20-7%20-500%2037%20-586%2040%20-80%20113%20-151%20201%20-195%20l76%20-39%20151%200%20151%200%2068%2034%20c81%2041%20167%20128%20215%20218%20l32%2061%200%20302%200%20302%20-41%2078%20c-65%20127%20-156%20201%20-284%20235%20-73%2019%20-255%2019%20-307%201z%20m262%20-311%20c58%20-30%2064%20-57%2068%20-301%204%20-219%204%20-222%20-19%20-253%20-65%20-88%20-230%20-95%20-286%20-13%20-16%2024%20-18%2055%20-21%20273%20l-3%20246%2038%2030%20c21%2017%2045%2033%2053%2036%2025%2011%20137%20-1%20170%20-18z'/%3e%3c/g%3e%3c/svg%3e",buttonIcon="data:image/svg+xml,%3c?xml%20version='1.0'%20standalone='no'?%3e%3c!DOCTYPE%20svg%20PUBLIC%20'-//W3C//DTD%20SVG%2020010904//EN'%20'http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd'%3e%3csvg%20version='1.0'%20xmlns='http://www.w3.org/2000/svg'%20width='171.000000pt'%20height='171.000000pt'%20viewBox='0%200%20171.000000%20171.000000'%20preserveAspectRatio='xMidYMid%20meet'%3e%3cg%20transform='translate(0.000000,171.000000)%20scale(0.100000,-0.100000)'%20fill='%23000000'%20stroke='none'%3e%3cpath%20d='M790%201280%20l0%20-420%2065%200%2065%200%200%20420%200%20420%20-65%200%20-65%200%200%20-420z'/%3e%3cpath%20d='M489%201612%20c-228%20-114%20-386%20-309%20-451%20-557%20-29%20-110%20-29%20-297%200%20-406%2081%20-301%20308%20-530%20607%20-610%20112%20-30%20307%20-30%20420%200%20294%2077%20529%20312%20606%20606%2029%20110%2030%20307%201%20416%20-67%20251%20-245%20462%20-477%20565%20l-55%2024%200%20-74%200%20-74%2072%20-42%20c280%20-167%20411%20-508%20313%20-817%20-35%20-110%20-88%20-196%20-175%20-283%20-87%20-87%20-172%20-139%20-285%20-177%20-70%20-23%20-96%20-27%20-210%20-27%20-114%200%20-140%204%20-210%2027%20-293%2097%20-495%20372%20-495%20673%200%2070%2025%20193%2055%20266%2054%20133%20182%20279%20299%20339%20l66%2034%200%2078%20c0%2042%20-1%2077%20-2%2077%20-2%200%20-37%20-18%20-79%20-38z'/%3e%3c/g%3e%3c/svg%3e",timerIcon="data:image/svg+xml,%3c?xml%20version='1.0'%20standalone='no'?%3e%3c!DOCTYPE%20svg%20PUBLIC%20'-//W3C//DTD%20SVG%2020010904//EN'%20'http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd'%3e%3csvg%20version='1.0'%20xmlns='http://www.w3.org/2000/svg'%20width='171.000000pt'%20height='171.000000pt'%20viewBox='0%200%20171.000000%20171.000000'%20preserveAspectRatio='xMidYMid%20meet'%3e%3cg%20transform='translate(0.000000,171.000000)%20scale(0.100000,-0.100000)'%20fill='%23000000'%20stroke='none'%3e%3cpath%20d='M818%201670%20c-24%20-15%20-31%20-77%20-23%20-221%208%20-141%2015%20-159%2064%20-159%2050%200%2060%2024%2063%20150%20l3%20115%2030%20-3%20c172%20-19%20366%20-132%20472%20-275%2094%20-129%20133%20-236%20140%20-392%206%20-142%20-12%20-230%20-73%20-355%20-82%20-165%20-236%20-296%20-419%20-357%20-71%20-24%20-95%20-27%20-215%20-27%20-118%200%20-145%203%20-212%2026%20-123%2041%20-204%2092%20-298%20187%20-68%2068%20-94%20103%20-127%20171%20-61%20125%20-76%20203%20-71%20352%206%20153%2036%20243%20122%20371%2064%2095%2068%20127%2021%20149%20-39%2017%20-68%202%20-113%20-59%20-94%20-127%20-150%20-285%20-159%20-449%20-23%20-399%20236%20-749%20632%20-855%20111%20-30%20297%20-30%20410%200%20449%20119%20716%20562%20610%201011%20-23%2095%20-105%20254%20-173%20336%20-111%20131%20-276%20234%20-442%20274%20-89%2021%20-213%2026%20-242%2010z'/%3e%3cpath%20d='M452%201258%20c-7%20-7%20-12%20-17%20-12%20-23%200%20-21%20330%20-469%20358%20-487%2043%20-28%20106%20-23%20143%2010%2043%2038%2052%20113%2020%20154%20-20%2025%20-454%20342%20-484%20354%20-7%202%20-18%20-1%20-25%20-8z'/%3e%3c/g%3e%3c/svg%3e",owIcon="data:image/svg+xml,%3c?xml%20version='1.0'%20standalone='no'?%3e%3c!DOCTYPE%20svg%20PUBLIC%20'-//W3C//DTD%20SVG%2020010904//EN'%20'http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd'%3e%3csvg%20version='1.0'%20xmlns='http://www.w3.org/2000/svg'%20width='110.000000pt'%20height='52.000000pt'%20viewBox='0%200%20110.000000%2052.000000'%20preserveAspectRatio='xMidYMid%20meet'%3e%3cg%20transform='translate(0.000000,52.000000)%20scale(0.100000,-0.100000)'%20fill='%23000000'%20stroke='none'%3e%3cpath%20d='M171%20500%20c-50%20-12%20-83%20-41%20-111%20-96%20-22%20-43%20-25%20-62%20-24%20-149%200%20-141%2027%20-199%20109%20-236%2073%20-33%20180%20-16%20227%2037%2067%2076%2074%20284%2013%20376%20-39%2059%20-133%2089%20-214%2068z%20m119%20-65%20c50%20-26%2065%20-67%2065%20-180%200%20-146%20-32%20-195%20-128%20-195%20-40%200%20-54%205%20-77%2028%20-16%2016%20-34%2049%20-40%2073%20-16%2056%20-7%20186%2014%20227%2030%2057%20105%2078%20166%2047z'/%3e%3cpath%20d='M482%20483%20c3%20-10%2029%20-120%2058%20-245%20l54%20-228%2038%200%20c43%200%2035%20-20%2089%20215%2017%2077%2035%20146%2038%20152%204%207%2026%20-73%2051%20-178%20l44%20-190%2039%203%2040%203%2058%20240%20c32%20132%2058%20241%2059%20243%200%202%20-15%202%20-32%200%20l-32%20-3%20-43%20-180%20c-23%20-99%20-44%20-187%20-46%20-195%20-2%20-8%20-25%2074%20-51%20183%20l-48%20198%20-36%20-3%20-36%20-3%20-45%20-194%20c-25%20-106%20-47%20-188%20-49%20-181%20-3%207%20-23%2095%20-46%20194%20l-42%20181%20-33%203%20c-28%203%20-33%201%20-29%20-15z'/%3e%3c/g%3e%3c/svg%3e",encoderIcon="data:image/svg+xml,%3c?xml%20version='1.0'%20standalone='no'?%3e%3c!DOCTYPE%20svg%20PUBLIC%20'-//W3C//DTD%20SVG%2020010904//EN'%20'http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd'%3e%3csvg%20version='1.0'%20xmlns='http://www.w3.org/2000/svg'%20width='34.000000pt'%20height='52.000000pt'%20viewBox='0%200%2034.000000%2052.000000'%20preserveAspectRatio='xMidYMid%20meet'%3e%3cg%20transform='translate(0.000000,52.000000)%20scale(0.100000,-0.100000)'%20fill='%23000000'%20stroke='none'%3e%3cpath%20d='M30%20255%20l0%20-245%20150%200%20150%200%200%2030%200%2030%20-115%200%20-115%200%200%2085%200%2085%2095%200%2095%200%200%2030%200%2030%20-95%200%20-95%200%200%2070%200%2070%20115%200%20115%200%200%2030%200%2030%20-150%200%20-150%200%200%20-245z'/%3e%3c/g%3e%3c/svg%3e",Icons={switchIcon:$=>Et`
  ...
  >
    ${$}
    <${oe?Icons.refresh:ct} class="w-4 ${oe?"animate-spin":""}" />
  <//>`}function Login({loginFn:$,logoIcon:_,title:k,tipText:dt}){const[ct,st]=ut(""),[pt,Yt]=ut(""),vt=function(oe){const ht={Authorization:"Basic "+btoa(ct+":"+pt)};return fetch("api/login",{headers:ht}).then($).finally(Zt=>Yt(""))};return Et` <div
  ...
  `,$e=({d:re})=>Et`
  <tr class="${xe(re.id)?"bg-red-200/50 opacity-50 pointer-events-none":re.id%2===1?"bg-white/80":"bg-sky-200/40"} hover:bg-slate-200/80 transition-colors">
    ...
    <td class="px-2 py-2">
      <div class="flex flex-wrap items-center justify-center gap-x-1 gap-y-1">
        <${fe} id=${re.id} value="0"  label="NONE"     checked=${k[`topin_${re.id}`]==="0"}  onChange=${me} />
        <${fe} id=${re.id} value="3"  label="SWITCH"   checked=${k[`topin_${re.id}`]==="3"}  onChange=${me} />
        <${fe} id=${re.id} value="1"  label="BUTTON"   checked=${k[`topin_${re.id}`]==="1"}  onChange=${me} />
        <${fe} id=${re.id} value="2"  label="DEVICE"   checked=${k[`topin_${re.id}`]==="2"}  onChange=${me} />
        <${fe} id=${re.id} value="4"  label="1-WIRE"   checked=${k[`topin_${re.id}`]==="4"}  onChange=${me} />
        <${fe} id=${re.id} value="5"  label="PWM"      disabled=${re.pwm==0} checked=${k[`topin_${re.id}`]==="5"}  onChange=${me} />
        <${fe} id=${re.id} value="8"  label="Enc.OutA" checked=${k[`topin_${re.id}`]==="8"}  onChange=${me} />
        <${fe} id=${re.id} value="9"  label="Enc.OutB" checked=${k[`topin_${re.id}`]==="9"}  onChange=${me} />
        <${fe} id=${re.id} value="10" label="Security" disabled=${re.monitoring==0} checked=${k[`topin_${re.id}`]==="10"} onChange=${me} />
      </div>
    </td>
  </tr>
`;return Et`
            ...
            <div class="flex items-center gap-3">
              ...
              <label class="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  class="sr-only peer"
                  checked=${le}
                  onChange=${re=>he(re.target.checked)}
                />
  ...
  `}function ModalSwitch({modalType:$,page:_,hideModal:k,closeOnOverlayClick:dt=!0,title:ct,selectedSwitch:st,onSwitchChange:pt,connectionOptions:Yt,SliderComponent:vt=MyPolzunok}){const[oe,le]=ut((st==null?void 0:st.info)||""),[ht,Zt]=ut((st==null?void 0:st.onoff)||0),[ne,he]=ut((st==null?void 0:st.ptype)||0),[xe,ge]=ut((st==null?void 0:st.setrpins)||""),[ue,me]=ut([]);lt(()=>{fetch("/api/select/get",{method:"GET",cache:"no-store",headers:{"Content-Type":"application/json"}}).then(ce=>{if(!ce.ok)throw new Error(`HTTP error! status: ${ce.status}`);return ce.json()}).then(ce=>{if(!ce||!ce.data||!Array.isArray(ce.data)){console.error("Invalid data format:",ce),me([]);return}const Ee=ce.data.filter(te=>te.topin===2);me(Ee)}).catch(ce=>{console.error("Error fetching pin config:",ce),me([])})},[]);const fe=ce=>{ce.preventDefault();const Ee=new FormData(ce.target),te=Object.fromEntries(Ee);if(te.id=st.id,te.pins=st.pins,$==="edit")te.onoff=ht;else if($==="connection"){const ae=ue.find(mt=>mt.pins===te.setrpins);ae&&(te.pinact={...st.pinact,[ae.id]:ae.pins})}fetch("/api/switch/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(te)}).then(ae=>ae.json()).then(ae=>{console.log("Success:",ae),pt({...st,...te}),k(),window.location.href="/#/switch"}).catch(ae=>{console.error("Error:",ae)})},$e=ce=>{ge(ce.target.value)},re=ce=>{he(parseInt(ce.target.value))},ye=ce=>{le(ce.target.value)},we=ce=>{Zt(ce)},Te=ce=>{dt&&ce.target===ce.currentTarget&&k()},Se=()=>{he(0),le(""),Zt(0)},_e=Et`
    <div
                ...
                <tbody>
                  ...
                  <tr class="bg-gray-200">
                    ...
                    <td class="p-2">
                      <select
                        name="setrpins"
                        value=${ue.some(ce=>ce.pins===xe)?xe:""}
                        onchange=${$e}
  ...
  `,ve=at(null);return lt(()=>{const ce=document.createElement("div");return ce.id="modal-portal",document.body.appendChild(ce),ve.current=ce,()=>{O(null,ce),document.body.removeChild(ce)}},[]),lt(()=>{ve.current&&O(_e,ve.current)}),null}function TabSwitch({}){const[$,_]=ut(null),[k,dt]=ut(null),[ct,st]=ut(!1),[pt,Yt]=ut(null),[vt,oe]=ut(null),[le,ht]=ut(!1),[Zt,ne]=ut("ru"),[he,xe]=ut(null),[ge,ue]=ut([]),[me,fe]=ut(""),[$e,re]=ut(!1),ye=()=>Promise.all([fetch("/api/switch/get").then(Xt=>Xt.json()),fetch("/api/pintopin/get").then(Xt=>Xt.json())]).then(([Xt,de])=>{ne(Xt.lang),xe(Xt.switches),_(Xt),ue(de),fe(`Pintopin data: ${JSON.stringify(de,null,2)}

Switch data: ${JSON.stringify(Xt.switches,null,2)}`),console.log("Pintopin data:",de),console.log("Switch data:",Xt.switches)}).catch(Xt=>{console.error("Error fetching data:",Xt),fe(`Error fetching data: ${Xt.message}`)}),we=()=>{fetch("/api/switch/get").then(Xt=>Xt.json()).then(Xt=>{xe(Xt.switches),ne(Xt.lang),console.log("Updated switch data:",Xt.switches)}).catch(Xt=>{console.error("Error fetching switch data:",Xt)})},Te=()=>{fetch("/api/pintopin/get").then(Xt=>Xt.json()).then(Xt=>{ue(Xt),console.log("Updated pintopin data:",Xt)}).catch(Xt=>{console.error("Error fetching pintopin data:",Xt)})};lt(()=>{we(),Te();const Xt=setInterval(()=>{we(),Te()},1e3);return()=>clearInterval(Xt)},[]);const Se=Xt=>{const de=new Map,be=he.find(Ce=>Ce.id===Xt);return be&&be.pinact&&Object.entries(be.pinact).forEach(([Ce,$t])=>{de.set(Ce,{pin:Ce,relayId:$t})}),ge.forEach(Ce=>{if(Ce.idin===Xt){const $t=`${Ce.pins}(${Ce.idout})`;de.has($t)||de.set($t,{pin:Ce.pins,relayId:Ce.idout})}}),Array.from(de.values())},pe=()=>Zt==="ru"?ruLangswitch:enLangswitch,_e=(Xt,de)=>{const $t=(pe()[de]||"").split(" "),se=[];let ie="";for(let ke=0;ke<$t.length;ke++){const Ie=$t[ke];ie.length+Ie.length+1<=200?ie+=(ie.length>0?" ":"")+Ie:(ie.length>0&&se.push(ie),ie=Ie)}return ie.length>0&&se.push(ie),se.join("<br>")},ve=(Xt,de)=>{console.log("Удаление соединения:",Xt,de);const[be,Ce]=de.split("("),$t=Ce?parseInt(Ce):null;fetch("/api/connection/del",{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:Xt,pin:be.trim()})}).then(se=>se.json()).then(se=>{dt(se),xe(ie=>ie.map(ke=>{if(ke.id===Xt){const Ie={...ke.pinact};return delete Ie[be.trim()],{...ke,pinact:Ie}}return ke})),ue(ie=>ie.filter(ke=>!(ke.idin===Xt&&ke.pins===be.trim()&&($t===null||ke.idout===$t))))}).then(()=>{console.log("Соединение удалено успешно"),ye()}).catch(se=>{console.error("Ошибка при удалении соединения:",se)})},ce=(Xt,de)=>{Yt(Xt),oe(de),st(!0)},Ee=()=>{st(!1),Yt(null),oe(null)},te=Xt=>{console.log("handleSwitchChange:",Xt),fetch("/api/onoff/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:Xt.id,onoff:Xt.onoff})}).then(de=>de.json()).then(de=>{console.log("Response from /api/onoff/set:",de)}).catch(de=>{console.error("Error calling /api/onoff/set:",de)}),Ee()},ae={ru:Et`
    ...
    <th class="px-6 py-4 text-2xl font-bold text-slate-700 tracking-wide relative group">
      ...
      <div
        ...
        dangerouslySetInnerHTML=${{__html:_e("langbutton",Xt.tooltipIndex)}}
      ></div>
    </th>
  `,ee=({d:Xt,index:de})=>{const be=Se(Xt.id);return Et`
      <tr class="${de%2===1?"bg-white/80":"bg-sky-200/40"} hover:bg-slate-200/80 transition-colors">
        ...
        <td class="px-6 py-2 text-sm text-slate-700 font-mono">
          ${be.map(({pin:Ce,relayId:$t})=>Et`
              <span class="mr-2 inline-flex items-center">
                ${Ce}${$t!==void 0?`(${$t})`:""}
                <button
                  onClick=${se=>{se.preventDefault(),ve(Xt.id,`${Ce}(${$t})`)}}
        ...
        <td class="px-6 py-2">
          <${MyPolzunok}
            value=${Xt.onoff}
            onChange=${Ce=>te({...Xt,onoff:Ce})}
          />
        </td>
        <td class="px-6 py-2 text-sm">
          <button
            onClick=${()=>ce("connection",Xt)}
              ...
              <div class="overflow-x-auto w-full">
                <table class="w-full text-left border-collapse whitespace-nowrap">
                  ...
                  <tbody id="tab1" class="divide-y divide-white/40">
                    ${he.map((Xt,de)=>Et`<${ee} d=${Xt} index=${de} key=${Xt.id} />`)}
                  </tbody>
                </table>
              </div>
            </div>
  ...
  `,portalRef=at(null);return lt(()=>{const $=document.createElement("div");return $.id="modal-portal",document.body.appendChild($),portalRef.current=$,()=>{O(null,$),document.body.removeChild($)}},[]),lt(()=>{portalRef.current&&O(modalContent,portalRef.current)}),null},TabButton=()=>{const[$,_]=ut(null),[k,dt]=ut([]),[ct,st]=ut(null),[pt,Yt]=ut(null),[vt,oe]=ut(!1),[le,ht]=ut(null),[Zt,ne]=ut(null),[he,xe]=ut(!1),[ge,ue]=ut("ru"),[me,fe]=ut(""),[$e,re]=ut(!0),ye={ru:Et`
    ...
    `},we=()=>{fetch("/api/button/get").then(mt=>mt.json()).then(mt=>{st(mt.buttons),ue(mt.lang),console.log("Updated button data:",mt.buttons)}).catch(mt=>{console.error("Error fetching button data:",mt)})};lt(()=>{we();let mt;return $e&&(mt=setInterval(()=>{we()},1e3)),()=>{mt&&clearInterval(mt)}},[$e]);const Te=mt=>{const ee=new Map,Xt=ct.find(de=>de.id===mt);return Xt&&Xt.pinact&&Object.entries(Xt.pinact).forEach(([de,be])=>{ee.set(de,{pin:de,relayId:be})}),k.forEach(de=>{if(de.idin===mt){const be=`${de.pins}(${de.idout})`;ee.has(be)||ee.set(be,{pin:de.pins,relayId:de.idout})}}),Array.from(ee.values())},Se=()=>({langbutton:ge==="ru"?rulangbutton:enlangbutton}),pe=(mt,ee)=>{const Xt=Se(),de=Xt[mt]&&Xt[mt][ee]?Xt[mt][ee]:"";return _e(de)},_e=(mt,ee=100)=>{if(!mt||typeof mt!="string")return"";const Xt=[];let de="";const be=mt.split(`
`);return be.forEach((Ce,$t)=>{Ce.split(" ").filter(ie=>ie.length>0).forEach((ie,ke)=>{const Ie=de.length===0?ie:" "+ie;de.length+Ie.length<=ee?de+=Ie:(de.length>0&&Xt.push(de),de=ie)}),de.length>0&&(Xt.push(de),de=""),$t<be.length-1&&Xt.push("")}),de.length>0&&Xt.push(de),Xt.join(`
`)},ve=(mt,ee)=>{ht(mt),ne(ee),oe(!0),re(!1)},ce=()=>{oe(!1),ht(null),ne(null),re(!0)},Ee=mt=>{console.log("handleButtonChange:",mt),st(ee=>ee.map(Xt=>Xt.id===mt.id?{...Xt,...mt}:Xt)),fetch("/api/onoff/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:mt.id,onoff:mt.onoff})}).then(ee=>ee.json()).then(ee=>{console.log("Response from /api/onoff/set:",ee)}).catch(ee=>{console.error("Error calling /api/onoff/set:",ee)}),ce()},te=mt=>Et`
    <th class="px-6 py-4 text-2xl font-bold text-slate-700 tracking-wide relative group" style="white-space: pre-line;">
      ...
      >
        ${pe("langbutton",mt.tooltipIndex)}
      </div>
    </th>
  `,ae=({d:mt,index:ee})=>(Te(mt.id),Et`
    ...
    ${vt&&Et`
      ...
      />
    `}
  `:""};function ModalEncoder({modalType:$,page:_,hideModal:k,closeOnOverlayClick:dt=!0,title:ct,selectedEncoder:st,handleEncoderChange:pt,connectionOptions:Yt,SliderComponent:vt=MyPolzunok}){const[oe,le]=ut((st==null?void 0:st.info)||""),[ht,Zt]=ut((st==null?void 0:st.onoff)===1),[ne,he]=ut({pin:(st==null?void 0:st.encdrbpin)||"",id:(st==null?void 0:st.encoderb)||""}),[xe,ge]=ut(Object.entries(st.pinact||{})[0]||["",""]),[ue,me]=ut([]),[fe,$e]=ut([]),[re,ye]=ut([]),[we,Te]=ut(st.dvalue||0),[Se,pe]=ut(st.ponr||0),[_e,ve]=ut(st.pwm||1e7);lt(()=>{fetch("/api/select/get",{method:"GET",cache:"no-store",headers:{"Content-Type":"application/json"}}).then(se=>{if(!se.ok)throw new Error(`HTTP error! status: ${se.status}`);return se.json()}).then(se=>{if(!se||!se.data||!Array.isArray(se.data)){console.error("Invalid data format:",se),me([]),$e([]),ye([]);return}const ie=se.data.filter(Oe=>Oe.topin===2),ke=se.data.filter(Oe=>Oe.topin===9),Ie=se.data.filter(Oe=>Oe.topin===5);if(me(ie),$e(ke),ye(Ie),st.encoderb||st.encdrbpin){const Oe=ke.find(Ne=>String(Ne.id)===String(st.encoderb)||Ne.pins===st.encdrbpin);he({pin:Oe?Oe.pins:"",id:Oe?Oe.id:""})}}).catch(se=>{console.error("Error fetching pin config:",se),me([]),$e([]),ye([])})},[st]);const ce=se=>{if(se.preventDefault(),se.target instanceof HTMLFormElement){let ke={};$==="edit"?ke={topin:8,id:st.id,pins:st.pins,pwm:parseInt(_e),dvalue:parseInt(we),ponr:parseInt(Se),info:oe,onoff:ht?1:0}:$==="connection"&&(ke={id:st.id,pins:st.pins,encoderb:parseInt(ne.id),encdrbpin:ne.pin,pinact:{[xe[0]]:parseInt(xe[1])}}),console.log("We got a encoder JSON:",JSON.stringify(ke)),fetch("/api/encoder/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(ke)}).then(Ie=>Ie.json()).then(Ie=>{pt({...st,...ke}),k()}).catch(Ie=>{console.error("Error:",Ie)})}else console.error("Form element not found")},Ee=se=>{le(se.target.value)},te=se=>{Zt(se)},ae=se=>{const ie=fe.find(ke=>ke.pins===se.target.value);he({pin:se.target.value,id:ie?ie.id:""})},mt=se=>{if(!se.target.value)ge(["",""]);else{const ie=se.target.value.split("|");ge([ie[0],ie[1]])}},ee=se=>{Te(se.target.value)},Xt=se=>{pe(se.target.value)},de=se=>{const ie=se/1e3;return ie<=4e4?{cls:"text-green-600",msg:"Optimal range"}:ie<=2e5?{cls:"text-yellow-600",msg:"Precision might drop"}:{cls:"text-red-600",msg:"Expert mode: low precision"}},Ce=Et`
    <div
      class="fixed inset-0 z-[999] bg-black bg-opacity-50"
      style="margin-top: 7px;"
    >
                ...
                <tbody>
                  ...
                  <tr class="bg-gray-200">
                    ...
                    <td class="p-2">
                      <select
                        name="encdrb"
                        value=${fe.some(se=>se.pins===ne.pin)?ne.pin:""}
                        onchange=${ae}
                        class="border rounded p-2 w-full"
                      >
                  ...
                  <tr class="bg-white">
                    ...
                    <td class="p-2">
                      <select
                        name="pwmconnection"
                        value=${re.some(se=>String(se.pins)===String(xe[0]))?`${xe[0]}|${xe[1]}`:""}
                        onchange=${mt}
                        class="border rounded p-2 w-full"
                      >
  ...
  `,$t=at(null);return lt(()=>{const se=document.createElement("div");return se.id="modal-portal",document.body.appendChild(se),$t.current=se,()=>{O(null,se),document.body.removeChild(se)}},[]),lt(()=>{$t.current&&O(Ce,$t.current)}),null}function TabEncoder({}){{const[$,_]=ut(null),[k,dt]=ut(null),[ct,st]=ut(!1),[pt,Yt]=ut(null),[vt,oe]=ut(null),[le,ht]=ut(!1),[Zt,ne]=ut("ru"),[he,xe]=ut([]),ge=at(!1),ue=()=>Promise.all([fetch("/api/encoder/get").then(mt=>mt.json()),fetch("/api/pintopin/get").then(mt=>mt.json())]).then(([mt,ee])=>{ne(mt.lang),_(mt.encoders),xe(ee),console.log("Encoder data:",mt.encoders),console.log("Pintopin data:",ee)}).catch(mt=>{console.error("Error fetching data:",mt)}),me=()=>{fetch("/api/encoder/get").then(mt=>mt.json()).then(mt=>{if(ge.current){console.log("Polling skip: onoff request in flight");return}_(mt.encoders),ne(mt.lang),console.log("Updated encoder data:",mt.encoders)}).catch(mt=>{console.error("Error fetching encoder data:",mt)})},fe=()=>{fetch("/api/pintopin/get").then(mt=>mt.json()).then(mt=>{xe(mt),console.log("Updated pintopin data:",mt)}).catch(mt=>{console.error("Error fetching pintopin data:",mt)})};lt(()=>{me(),fe();const mt=setInterval(()=>{me(),fe()},500);return()=>clearInterval(mt)},[]);const $e=mt=>{_(ee=>ee.map(Xt=>Xt.id===mt.id?mt:Xt)),ge.current=!0,fetch("/api/onoff/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:mt.id,onoff:mt.onoff})}).then(ee=>ee.json()).then(ee=>{console.log("Response from /api/onoff/set (Encoder):",ee)}).catch(ee=>{console.error("Error calling /api/onoff/set (Encoder):",ee)}).finally(()=>{ge.current=!1})},re=mt=>{const ee=$.find(de=>de.id===mt),Xt=[];return ee&&ee.pinact&&Object.entries(ee.pinact).forEach(([de,be])=>{Xt.push({pin:de,idout:be})}),Xt},ye=mt=>{const ee=mt/1e3;return ee<=4e4?{cls:"text-green-600",msg:"✓"}:ee<=2e5?{cls:"text-yellow-600",msg:"~"}:{cls:"text-red-600",msg:"!"}},we=mt=>{if(!mt)return"—";const ee=mt/1e3;return ee>=1e6?`${(ee/1e6).toFixed(2)} MHz`:ee>=1e3?`${(ee/1e3).toFixed(1)} kHz`:`${ee} Hz`},Te=()=>({langbutton:Zt==="ru"?ruencoder:enencoder}),Se=(mt,ee)=>{const Xt=Te(),de=Xt[mt]&&Xt[mt][ee]?Xt[mt][ee]:"";return pe(de)},pe=(mt,ee=50)=>{if(!mt||typeof mt!="string")return"";const Xt=mt.split(" ");let de=[],be="";for(let Ce=0;Ce<Xt.length;Ce++)be.length+Xt[Ce].length+1<=ee?be+=`${be?" ":""}${Xt[Ce]}`:(be&&de.push(be.trim()),be=Xt[Ce]);return be&&de.push(be.trim()),de.join(`
`)},_e=(mt,ee)=>{console.log("Deleting connection:",mt,ee);const Xt=ee.split("(")[0].trim();fetch("/api/connection/del",{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:mt,pin:Xt})}).then(de=>de.ok?de.json():de.text().then(be=>{throw new Error(`HTTP error! status: ${de.status}, message: ${be}`)})).then(de=>{dt(de),_(be=>be.map(Ce=>{if(Ce.id===mt){const $t={...Ce.pinact};return delete $t[Xt],{...Ce,pinact:$t}}return Ce})),xe(be=>be.filter(Ce=>!(Ce.idin===mt&&Ce.pins===Xt)))}).then(()=>{console.log("Connection deleted successfully"),ue()}).catch(de=>{console.error("Error deleting connection:",de)})},ve=(mt,ee)=>{console.log("Opening modal:",mt,ee),Yt(mt),oe(ee),st(!0)},ce=()=>{st(!1),Yt(null),oe(null)},Ee={ru:Et`
      <div class="mytext space-y-6">
        <div>
          <pre class="mb-4">
    ...
    `},te=({title:mt,tooltipIndex:ee})=>Et`
    <th class="px-6 py-4 text-2xl font-bold text-slate-700 tracking-wide relative group">
      ${mt}
      <div
  ...
  `,ae=({d:mt,index:ee})=>{const Xt=re(mt.id),de=ye(mt.pwm||0);return Et`
      <tr class="${ee%2===1?"bg-white/80":"bg-sky-200/40"} hover:bg-slate-200/80 transition-colors">
        ...
        <td class="px-6 py-2 text-sm text-slate-700 font-mono">
          ${Xt.length>0?Xt.map(({pin:be,idout:Ce})=>Et`
                  <span class="mr-2 inline-flex items-center">
                    ${be}(${Ce})
                    <button
                      onClick=${$t=>{$t.preventDefault(),_e(mt.id,`${be}(${Ce})`)}}
                      class="ml-1 text-red-500 hover:text-red-700 transition-colors font-bold"
                      title="Remove connection"
                    >
                      [x]
        ...
        <td class="px-6 py-2 text-sm">
          <span class="font-mono text-slate-700">${we(mt.pwm)}</span>
          <span class="ml-1 font-bold ${de.cls}">${de.msg}</span>
        </td>
        ...
        <td class="px-6 py-2">
          <${MyPolzunok}
            value=${mt.onoff}
            onChange=${be=>$e({...mt,onoff:be})}
          />
        </td>
        <td class="px-6 py-2 text-sm whitespace-nowrap">
          <button
            onClick=${()=>ve("connection",mt)}
            class="text-teal-600 hover:text-cyan-600 font-semibold transition-colors mr-2"
          >
            Connection
          </button>
            ...
            <div class="rounded-2xl overflow-hidden bg-white/50 backdrop-blur-xl border border-white/60 shadow-inner w-full mb-6">
              <div class="overflow-x-auto w-full">
                <table class="w-full text-left border-collapse whitespace-nowrap">
                  ...
                  <tbody id="tab1" class="divide-y divide-white/40">
                    ${$.map((mt,ee)=>Et`<${ae} d=${mt} index=${ee} key=${mt.id} />`)}
                  </tbody>
                </table>
              </div>
            </div>
  ...
  `:Et`<div class="flex items-center justify-center p-8 text-slate-500 font-medium">Loading...</div>`}}function ModalCron({modalType:$,page:_,hideModal:k,closeOnOverlayClick:dt=!0,title:ct,selectedCron:st,handleCronChange:pt,connectionOptions:Yt,modalClass:vt,SliderComponent:oe=MyPolzunok}){const[le,ht]=ut((st==null?void 0:st.info)||""),[Zt,ne]=ut((st==null?void 0:st.onoff)===1),[he,xe]=ut((st==null?void 0:st.activ)||""),[ge,ue]=ut((st==null?void 0:st.cron)||""),[me,fe]=ut(st.setrpins||""),$e=ve=>{ve.preventDefault();const ce=new FormData(ve.target),Ee=Object.fromEntries(ce);Ee.id=st.id,Ee.pins=st.pins,$==="edit"?(Ee.onoff=Zt?1:0,Ee.info=le,Ee.cron=ge,Ee.activ=he):$==="connection"&&(Ee.setrpins=me),console.log("Data being sent to server:"),console.log(Ee),console.log("Stringified data:"),console.log(JSON.stringify(Ee)),fetch("/api/cron/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(Ee)}).then(te=>te.json()).then(te=>{console.log("Success:",te),pt({...st,...Ee}),k(),window.location.href="/#/cron"}).catch(te=>{console.error("Error:",te)})};lt(()=>{ht((st==null?void 0:st.info)||""),fe((st==null?void 0:st.setrpins)||""),ne((st==null?void 0:st.onoff)===1)},[st]);const re=ve=>{ue(ve.target.value)},ye=ve=>{ht(ve.target.value)},we=ve=>{ne(ve)},Te=ve=>{xe(ve.target.value)},Se=()=>{if(_==="TabCron"&&$==="edit")return Et`
          <form onsubmit=${$e}>
            <div class="modal-body">
              <table class="table-auto w-full">
                <tbody>
    ...
    <div class=${`modal ${vt||""}`}>
      <div class="modal-content">
        <div
          ...
          onclick=${ve=>dt&&ve.target===ve.currentTarget&&k()}
        >
          <div
  ...
  `,_e=at(null);return lt(()=>{const ve=document.createElement("div");return ve.id="modal-portal",document.body.appendChild(ve),_e.current=ve,()=>{O(null,ve),document.body.removeChild(ve)}},[]),lt(()=>{_e.current&&O(pe,_e.current)}),null}function TabCron({}){const[$,_]=ut(null),[k,dt]=ut(null);at(null);const[ct,st]=ut(!1),[pt,Yt]=ut(null),[vt,oe]=ut(null),[le,ht]=ut("ru"),[Zt,ne]=ut(!1),[he,xe]=ut(1),[ge,ue]=ut(0),me=()=>fetch("/api/cron/get").then(te=>te.json()).then(te=>{console.log("API response:",te),te&&Array.isArray(te.timers)?(_(te.timers),ht(te.lang||"ru"),typeof te.numline=="number"&&(ue(te.numline),xe(te.numline))):(console.error("Unexpected API response structure:",te),_([]))}).catch(te=>{console.error("Error fetching cron data:",te),_([])});lt(()=>{me()},[]),lt(()=>{fe(ge)},[ge]);const fe=te=>{fetch("/api/numline/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({numline:te})}).then(ae=>ae.json()).then(ae=>console.log("Numline sent to stm32:",ae)).catch(ae=>console.error("Error sending Crone line to stm32:",ae))},$e=()=>{if(he<$.length){const te=he+1;xe(te),ue(te),fe(te)}},re=()=>{if(he>0){const te=he-1;xe(te),ue(te),fe(te)}},ye={ru:Et`
      <div class="mytext">
        <div>
          <pre>
    ...
    `};if($===null)return Et`<div>Loading...</div>`;const we=()=>({langtimers:le==="ru"?rulangtimers:enlangtimers}),Te=(te,ae)=>{const mt=we(),Xt=(mt[te]&&mt[te][ae]?mt[te][ae]:"").split(" "),de=[];for(let be=0;be<Xt.length;be+=15)de.push(Xt.slice(be,be+15).join(" "));return de.join("<br>")},Se=(te,ae)=>{Yt(te),oe(ae),st(!0)},pe=()=>{st(!1),Yt(null),oe(null)},_e=te=>{console.log("handleCronChange:",te),_($.map(ae=>ae.id===te.id?te:ae)),fetch("/api/cron/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(te)}).then(ae=>ae.json()).then(ae=>{console.log("Cron job updated successfully:",ae)}).catch(ae=>{console.error("Error updating cron job:",ae)})},ve=()=>Array.isArray(vt)?vt.flatMap(te=>te.pinact?Object.keys(te.pinact).map(ae=>({value:ae,label:ae})):[]):vt&&vt.pinact?Object.keys(vt.pinact).map(te=>({value:te,label:te})):[],ce=te=>Et`
    <th class="px-6 py-4 text-2xl font-bold text-slate-700 tracking-wide relative group">
      ${te.title}
      <div
        class="absolute z-50 invisible group-hover:visible bg-white/90 backdrop-blur-md p-3 rounded-xl shadow-xl border border-slate-200 text-left text-sm font-normal text-slate-600 whitespace-normal break-words transform -translate-x-1/2 left-1/2 top-full mt-2"
  ...
  `;return Et`
    <div class="m-2 sm:m-4 lg:m-8 p-4 md:p-8 rounded-3xl bg-white/40 backdrop-blur-md border border-white/40 shadow-xl relative overflow-hidden flex-grow flex flex-col justify-center items-center">
      ...
      <div class="flex-grow flex flex-col justify-center items-center w-full relative z-10">
                ...
                <div class="rounded-2xl overflow-hidden bg-white/50 backdrop-blur-xl border border-white/60 shadow-inner w-full mb-6">
                  <div class="overflow-x-auto w-full">
                    <table class="w-full text-left border-collapse whitespace-nowrap">
                      ...
                      <tbody class="divide-y divide-white/40">
                        ${$.slice(0,he).map((te,ae)=>Et`<${Ee} d=${te} index=${ae} key=${te.id} />`)}
                      </tbody>
                    </table>
                  </div>
                </div>
        ...
        <div class="w-full flex justify-between items-center mb-4 mt-2 bg-white/40 backdrop-blur-md border border-white/60 shadow-sm p-4 rounded-2xl">
          ...
          <div class="font-semibold text-slate-600 tracking-wide">
            ${$&&$.length-he>0?`Still available: ${$.length-he} cron jobs`:"No available: cron jobs!"}
          </div>
      ...
      ${Zt&&Et`<div class="mt-6 p-6 bg-white/70 backdrop-blur-md rounded-2xl border border-white/60 shadow-inner text-slate-700 w-full">${ye[le]}</div>`}
      ${ct&&Et`
        <${ModalCron}
          modalType=${pt}
          page="TabCron"
  ...
  `}function ModalEditSensor({typsensor:$,oneWireId:_,pins:k,onClose:dt,onUpdate:ct,sensorType:st,sensorData:pt,closeOnOverlayClick:Yt=!0}){const[vt,oe]=ut({ut:(pt==null?void 0:pt.ut)||$.ut,lt:(pt==null?void 0:pt.lt)||$.lt,action_ut:(pt==null?void 0:pt.action_ut)||$.action_ut,action_lt:(pt==null?void 0:pt.action_lt)||$.action_lt,upphumid:(pt==null?void 0:pt.upphumid)||$.upphumid||0,humlolim:(pt==null?void 0:pt.humlolim)||$.humlolim||0,actuphum:(pt==null?void 0:pt.actuphum)||$.actuphum||"",actlowhum:(pt==null?void 0:pt.actlowhum)||$.actlowhum||"",info:(pt==null?void 0:pt.info)||$.info,onoff:(pt==null?void 0:pt.onoff)||$.onoff||0,humidity:(pt==null?void 0:pt.humidity)||$.humidity||0}),[le,ht]=ut(!1),Zt=(fe,$e,re)=>{if(fe===""||fe==="-")return fe;const ye=fe.replace(",",".");if(!/^-?\d*\.?\d*$/.test(ye))return null;const we=parseFloat(ye);return isNaN(we)||we<$e||we>re?null:ye},ne=fe=>{const{name:$e,value:re}=fe.target;if(["ut","lt"].includes($e)){const ye=Zt(re,-55,125);ye!==null&&oe(we=>({...we,[$e]:ye}))}else if(["upphumid","humlolim"].includes($e)){const ye=Zt(re,0,100);ye!==null&&oe(we=>({...we,[$e]:ye}))}else oe(ye=>({...ye,[$e]:re}))},he=fe=>{const $e=["ut","lt","upphumid","humlolim"],re={...fe};return $e.forEach(ye=>{re[ye]===""||re[ye]==="-"?re[ye]=0:re[ye]=parseFloat(re[ye].toString().replace(",","."))}),re},ue=Et`
    <div
      class="fixed inset-0 z-[999] bg-black bg-opacity-50 flex items-center justify-center p-4"
      onclick=${fe=>{Yt&&fe.target===fe.currentTarget&&dt()}}
    >
      <div
      ...
      >
        ...
        <form onsubmit=${async fe=>{fe.preventDefault(),ht(!0);const $e=he(vt);try{if(!(await fetch("/api/sensor/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:_,pins:k,sensorNumber:$.s_number,...$e,s_number:$.s_number,t:$.t})})).ok)throw new Error("Network response was not ok");ct({...$,...$e,oneWireId:_,pins:k,s_number:$.s_number,t:$.t}),dt()}catch(re){console.error("Error updating Sensor:",re)}finally{ht(!1)}}}>
          <div class="modal-body">
            <table class="table-auto w-full">
              <tbody>
  ...
  `,me=at(null);return lt(()=>{const fe=document.createElement("div");return fe.id="modal-portal-sensor",document.body.appendChild(fe),me.current=fe,()=>{O(null,fe),document.body.removeChild(fe)}},[]),lt(()=>{me.current&&O(ue,me.current)}),null}function ModalOneWire({oneWire:$,onClose:_,onUpdate:k,refresh:dt,closeOnOverlayClick:ct=!0}){console.log("oneWire object:",$);const[st,pt]=ut({typsensor:$.typsensor,numdevices:$.numdevices}),[Yt,vt]=ut(!1),[oe,le]=ut($.onoff||0),ht=ue=>{ct&&ue.target===ue.currentTarget&&_()},Zt=ue=>{const{name:me,value:fe}=ue.target;let $e={...st,[me]:parseInt(fe,10)};me==="typsensor"&&(fe==="0"?$e.numdevices=0:fe==="2"&&($e.numdevices=1)),pt($e)},ne=ue=>{le(ue)},xe=Et`
    <div
      class="fixed inset-0 z-[999] bg-black bg-opacity-50 flex items-center justify-center p-4"
      onclick=${ht}
    >
      ...
      >
        ...
        <form onsubmit=${async ue=>{ue.preventDefault(),vt(!0);const me={id:$.id,pin:$.pin,typsensor:st.typsensor,numdevices:st.numdevices,onoff:oe};console.log("Sending data:",me);try{if(!(await fetch("api/onewire/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(me)})).ok)throw new Error("Network response was not ok");const $e={...$,...st,onoff:oe};k($e),_()}catch(fe){console.error("Error updating OneWire:",fe)}finally{vt(!1)}}}>
          <div class="modal-body">
            <table class="table-auto w-full">
              <tbody>
                <tr class="bg-white">
  ...
  `,ge=at(null);return lt(()=>{const ue=document.createElement("div");return ue.id="modal-portal-onewire",document.body.appendChild(ue),ge.current=ue,()=>{O(null,ue),document.body.removeChild(ue)}},[]),lt(()=>{ge.current&&O(xe,ge.current)}),null}const TabOneWire=()=>{const[$,_]=ut([]),[k,dt]=ut(null),[ct,st]=ut(!1),[pt,Yt]=ut(null),[vt,oe]=ut(null),[le,ht]=ut("ru"),[Zt,ne]=ut(null),he=()=>{console.log("Calling initial refresh..."),fetch("/api/onewire/get").then(pe=>pe.json()).then(pe=>{console.log("Initial data received:",pe),ht(pe.lang||"ru"),_(pe.pins||[]),console.log("Initial OneWire state set:",pe.pins),dt(null)}).catch(pe=>{console.error("Error in refresh:",pe),dt(pe.message),_([])})},xe=async()=>{try{const _e=await(await fetch("/api/temp/get")).json();_(ve=>ve.map(ce=>{if(!ce.sensors||ce.typsensor!==1&&ce.typsensr!==1&&ce.typsensor!==2&&ce.typsensr!==2)return ce;const Ee=ce.sensors.map(te=>{var ae,mt;if(ce.typsensor===1||ce.typsensr===1){const ee=(ae=_e.ds18b20)==null?void 0:ae.find(Xt=>Xt.addr===te.s_number);if(ee)return{...te,t:ee.temp}}else if(ce.typsensor===2||ce.typsensr===2){const ee=(mt=_e.dht22)==null?void 0:mt.find(Xt=>Xt.id===ce.id);if(ee)return{...te,t:ee.temp,humidity:ee.humidity}}return te});return{...ce,sensors:Ee}}))}catch(pe){console.error("Error in updateSensorData:",pe)}};lt(()=>{console.log("Setting up initial data and interval..."),he();const pe=setInterval(xe,1e3);return()=>{clearInterval(pe)}},[]);const ge=()=>{st(!1),Yt(null),oe(null)},ue=pe=>{_(_e=>_e.map(ve=>{var ce;if(ve.id===pe.oneWireId){const Ee=((ce=ve.sensors)==null?void 0:ce.map(te=>te.s_number===pe.s_number?{...te,...pe}:te))||[];return{...ve,sensors:Ee}}return ve})),ge()},me=pe=>{oe(pe),st(!0)},fe=pe=>{_(_e=>_e.map(ve=>ve.id===pe.id?{...ve,onoff:pe.onoff}:ve))},$e=pe=>{_(_e=>_e.map(ve=>ve.id===pe.id?pe:ve)),ge()};if(k)return Et`<div>Error fetching sensor data: ${k}</div>`;const re=()=>({lang1Wire:le==="ru"?rulange1Wire:enlange1Wire}),ye=(pe,_e)=>{const ve=re(),Ee=(ve[pe]&&ve[pe][_e]?ve[pe][_e]:"").split(" "),te=[];for(let ae=0;ae<Ee.length;ae+=15)te.push(Ee.slice(ae,ae+15).join(" "));return te.join("<br>")},we=pe=>Et`
    <th class="px-6 py-4 text-2xl font-bold text-slate-700 tracking-wide relative group">
      ${pe.title}
      <div
        class="absolute z-50 invisible group-hover:visible bg-white/90 backdrop-blur-md p-3 rounded-xl shadow-xl border border-slate-200 text-left text-sm font-normal text-slate-600 whitespace-normal break-words transform -translate-x-1/2 left-1/2 top-full mt-2"
        style="width: fit-content; max-width: 80vw;"
      >
        ${ye("lang1Wire",pe.tooltipIndex)}
      </div>
    </th>
  `,Te=({device:pe,index:_e})=>{const ve=pe.pins||pe.pin,ce=pe.typsensor||pe.typsensr||0,Ee=pe.numdevices||pe.numsens||0;return Et`
      <tr class="${_e%2===1?"bg-white/80":"bg-sky-200/40"} hover:bg-slate-200/80 transition-colors">
      ...
      ${ce!==0&&Ee>0?Et`
          ...
          `:""}
    `},Se=({d:pe})=>{const _e=pe.typsensor||pe.typsensr||0,ve=pe.numdevices||pe.numsens||0;if(_e===0||ve===0)return Et`
        <div class="px-4 py-2 text-slate-500 font-medium">
          No connected sensors for this OneWire pin.
        </div>
      `;let ce=pe.sensors||[];const Ee=(te,ae)=>{const mt=_e===2;return Et`
        <div class="bg-white/70 backdrop-blur-md p-6 rounded-2xl shadow-lg border border-white/60 mb-4 transition-all hover:shadow-xl">
          <div class="font-extrabold text-xl text-slate-700 mb-4 flex justify-between items-center border-b border-slate-200/60 pb-3">
            ...
            <a
              ...
              onclick=${ee=>{ee.preventDefault(),Yt({...te,oneWireId:pe.id,sensorType:_e,pins:pe.pins||pe.pin}),st(!0)}}
            >
              Edit
            </a>
          </div>
      ...
      `};return ce.length>0&&Object.keys(ce[0]).length>0?Et`<div class="space-y-4 w-full">${ce.map((te,ae)=>Ee(te))}</div>`:Et`
            ...
            <div class="rounded-2xl bg-white/50 backdrop-blur-xl border border-white/60 shadow-inner w-full mb-6">
              <div class="overflow-x-auto w-full">
                <table class="w-full text-left border-collapse whitespace-nowrap">
                  <thead>
                    <tr class="bg-teal-600/10 border-b border-teal-600/20">
                      <${we} title="ID" tooltipIndex=${1} />
                      <${we} title="Pin" tooltipIndex=${2} />
                      <${we} title="Selected sensor" tooltipIndex=${3} />
                      <${we} title="Count of sensors" tooltipIndex=${4} />
                      <${we} title="On/Off" tooltipIndex=${5} />
                      <${we} title="Actions" tooltipIndex=${6} />
                    </tr>
                  </thead>
                  <tbody id="tab1" class="divide-y divide-white/40">
                    ${$.length>0?$.map((pe,_e)=>Et`<${Te} device=${pe} index=${_e} key=${pe.id} />`):Et`
                          <tr>
    ...
    ${ct&&(pt?Et`
          ...
          `:Et`
            ...
            />
          `)}
  `};function ModalSIM800L({hideModal:$,title:_,selectedGps:k,onSave:dt}){const[ct,st]=ut((k==null?void 0:k.tel)||""),[pt,Yt]=ut((k==null?void 0:k.info)||""),[vt,oe]=ut((k==null?void 0:k.onoff)===1),[le,ht]=ut(!0),Zt=ue=>/^\+\d{11,20}$/.test(ue),xe=Et`
    <div
      class="fixed inset-0 z-[999] bg-black bg-opacity-50"
      style="margin-top: 7px;"
    >
      <div class="flex items-center justify-center min-h-full p-4">
        ...
        >
          ...
          <form onSubmit=${ue=>{if(ue.preventDefault(),!le)return;const me={tel:ct,info:pt,onoff:vt?1:0};console.log("Сохраняемые данные:",me),fetch("/api/sim800l/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(me)}).then(fe=>fe.json()).then(fe=>{typeof dt=="function"&&dt(me),$()}).catch(fe=>{console.error("Error:",fe)})}}>
            <div class="modal-body">
              <table class="table-auto w-full">
                <tbody>
                  <tr class="bg-gray-200">
                  ...
                  <tr class="bg-gray-200">
                    ...
                    <td class="p-2">
                      <input
                        type="text"
                        value=${ct}
                        onInput=${ue=>{const me=ue.target.value;st(me),ht(Zt(me))}}
                  ...
                  <tr class="bg-gray-200">
                    <td class="p-2 font-bold">On/Off</td>
                    <td class="p-2">
                      <${MyPolzunok} value=${vt} onChange=${oe} />
                    </td>
                  </tr>
                </tbody>
              </table>
  ...
  `,ge=at(null);return lt(()=>{const ue=document.createElement("div");return ue.id="modal-portal",document.body.appendChild(ue),ge.current=ue,()=>{O(null,ue),document.body.removeChild(ue)}},[]),lt(()=>{ge.current&&O(xe,ge.current)}),null}const ModalSecurity=({modalType:$,page:_,hideModal:k,title:dt,selectedSecurity:ct,onSecurityChange:st,SliderComponent:pt=MyPolzunok})=>{const[Yt,vt]=ut((ct==null?void 0:ct.info)||""),[oe,le]=ut((ct==null?void 0:ct.onoff)||0),[ht,Zt]=ut((ct==null?void 0:ct.ptype)||0),[ne,he]=ut((ct==null?void 0:ct.send_sms)||""),[xe,ge]=ut((ct==null?void 0:ct.action)||""),[ue,me]=ut([]),[fe,$e]=ut({send_sms:null,action:null}),[re,ye]=ut(null),we=/^(None|\d{1,2}:[012])(,\d{1,2}:[012])*$/,Te=(ae,mt)=>!mt||mt.trim()===""||mt.toLowerCase()==="none"?null:ae==="action"?we.test(mt)?null:'Incorrect format. Use "None" or "pin:value" format.':mt.length>100?"Text should not exceed 100 characters":null,Se=(ae,mt)=>{const ee=Te(ae,mt);switch($e(Xt=>({...Xt,[ae]:ee})),ae){case"send_sms":he(mt);break;case"action":ge(mt);break}};lt(()=>{fetch("/api/monitoring/get").then(ae=>ae.json()).then(ae=>{Array.isArray(ae)?me(ae.filter(mt=>mt.topin===2)):me([])}).catch(ae=>{console.error("Error fetching pin config:",ae),me([])})},[]);const pe=ae=>{if(ae.preventDefault(),Object.values(fe).some(ee=>ee!==null)){ye("Please correct the errors before submitting.");return}const mt={...ct,info:Yt,send_sms:ne||"NO",action:xe||"None",onoff:oe,ptype:ht};fetch("/api/monitoring/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(mt)}).then(ee=>{if(!ee.ok)throw new Error("Network response was not ok");return ee.json()}).then(ee=>{if(ee.error)throw new Error(ee.error);st(mt),k()}).catch(ee=>{console.error("Error:",ee),ye("Failed to save changes. Please try again.")})},_e=()=>{Zt(0),he(""),ge(""),vt(""),le(0),$e({send_sms:null,action:null})},Ee=Et`
    <div
      class="fixed inset-0 z-[999] bg-black bg-opacity-50"
      style="margin-top: 7px;"
    >
          ...
          <tbody>
            ...
            <tr class="bg-gray-200">
              ...
              <td class="p-2">
                <select
                  name="setrpins"
                  value=${ue.some(ae=>ae.pins===(ct==null?void 0:ct.setrpins))?ct==null?void 0:ct.setrpins:""}
                  onChange=${ae=>st({...ct,setrpins:ae.target.value})}
                  class="border rounded p-2 w-full"
                >
                  <option value="">Select a connection</option>
                  ${ue.map(ae=>Et`
  ...
  `:Et`
    <form onSubmit=${pe}>
            ...
            <tr class="bg-gray-200">
              ...
              <td class="p-2">
                <select
                  name="ptype"
                  value=${ht}
                  onChange=${ae=>Zt(parseInt(ae.target.value))}
                  class="border rounded p-2 w-full"
                >
            ...
            <tr class="bg-gray-200">
              ...
              <td class="p-2">
                <input
                  ...
                  name="action"
                  value=${xe}
                  onInput=${ae=>Se("action",ae.target.value)}
            ...
            <tr class="bg-white">
              ...
              <td class="p-2">
                <select
                  name="send_sms"
                  value=${ne}
                  onchange=${ae=>Se("send_sms",ae.target.value)}
      ...
      ${re&&Et`<p class="text-red-500 mt-2">${re}</p>`}
    </form>
  `}
        </div>
      </div>
    </div>
  `,te=at(null);return lt(()=>{const ae=document.createElement("div");return ae.id="modal-portal",document.body.appendChild(ae),te.current=ae,()=>{O(null,ae),document.body.removeChild(ae)}},[]),lt(()=>{te.current&&O(Ee,te.current)}),null},TabSecurity=()=>{const[$,_]=ut({lang:"ru",sim800l:0,onoff:0,tel:"",info:""}),[k,dt]=ut(!1),[ct,st]=ut(!1),[pt,Yt]=ut([]),[vt,oe]=ut(!1),[le,ht]=ut("ru"),[Zt,ne]=ut(!1),[he,xe]=ut(""),[ge,ue]=ut(null),[me,fe]=ut(!1),[$e,re]=ut("connected"),[ye,we]=ut(0),Te=(ee,Xt)=>{let de;return(...be)=>{clearTimeout(de),de=setTimeout(()=>ee(...be),Xt)}},Se=async(ee,Xt={},de=3)=>{try{const be=await fetch(ee,Xt);if(!be.ok)throw new Error("Network response was not ok");return re("connected"),be}catch(be){if(re("error"),de>0)return await new Promise(Ce=>setTimeout(Ce,1e3)),Se(ee,Xt,de-1);throw re("disconnected"),be}},pe={ru:Et`
    ...
    `},ve=async()=>{if(!(me||Date.now()-ye<500))try{const Xt=await(await Se("/api/sim800l/get")).json();_(Xt)}catch(ee){console.error("Error fetching SIM800L data:",ee)}},ce=async()=>{if(!(me||Date.now()-ye<500))try{const Xt=await(await Se("/api/monitoring/get")).json();Yt(Xt.pins||[]),ht(Xt.lang||"ru")}catch(ee){console.error("Error fetching monitoring data:",ee)}};lt(()=>{const ee=setInterval(()=>{ve(),ce()},500);return()=>clearInterval(ee)},[]);const Ee=Te(async ee=>{fe(!0);try{const Xt=await Se("/api/sim800l/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(ee)});_(ee),we(Date.now())}catch(Xt){console.error("Error updating SIM800L:",Xt)}finally{fe(!1)}},300),te=async ee=>{try{const Xt=await fetch("/api/monitoring/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(ee)});if(!Xt.ok)throw new Error(`HTTP error! status: ${Xt.status}`);Yt(de=>de.map(be=>be.id===ee.id?ee:be)),await ce(),ne(!1)}catch(Xt){console.error("Error updating security:",Xt),alert("Failed to save changes. Please try again."),await ce()}},ae=ee=>{console.log("handleOnOffChange:",ee),Yt(Xt=>Xt.map(de=>de.id===ee.id?{...de,...ee}:de)),fetch("/api/onoff/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:ee.id,onoff:ee.onoff})}).then(Xt=>Xt.json()).then(Xt=>{console.log("Response from /api/onoff/set:",Xt)}).catch(Xt=>{console.error("Error calling /api/onoff/set:",Xt)}),closeModal()},mt=(ee,Xt)=>{xe(ee),ue(Xt),ne(!0)};return Et`
              ...
              <tbody class="divide-y divide-white/40">
                ${pt.length>0?pt.map((ee,Xt)=>Et`
                        ...
                        >
                          ...
                          <td class="px-6 py-4 text-sm text-slate-800 font-medium">${ee.pins}</td>
                          <td class="px-6 py-4 text-sm text-slate-800 font-medium">
                            ${["PIR","Normal open","Normal close"][ee.ptype]}
                          </td>
                          <td class="px-6 py-4 text-sm text-slate-800 font-medium">${ee.action}</td>
                          <td class="px-6 py-4 text-sm text-slate-800 font-medium">${ee.send_sms}</td>
                          <td class="px-6 py-4 text-sm text-slate-800 font-medium">${ee.info}</td>
                          <td class="px-6 py-4 text-sm text-slate-800 font-medium">
                            <${MyPolzunok}
                              value=${ee.onoff}
                              onChange=${de=>ae({...ee,onoff:de})}
                            />
                          </td>
                          <td class="px-6 py-4 text-sm text-slate-800 font-medium">
                            <button
  ...
  `};function Settings({}){const[$,_]=ut({}),[k,dt]=ut(null),[ct,st]=ut(null),[pt,Yt]=ut({}),vt=at(null),[oe,le]=ut(null),[ht,Zt]=ut(null),[ne,he]=ut(!1),[xe,ge]=ut(!1),[ue,me]=ut(!1),[fe,$e]=ut(!1),[re,ye]=ut(!1),[we,Te]=ut(!0),Se=[{value:"en",label:"English"},{value:"ru",label:"Russian"}],pe=[[-12,"(GMT -12:00) Eniwetok, Kwajalein"],[-11,"(GMT -11:00) Midway Island, Samoa"],[-10,"(GMT -10:00) Hawaii"],[-9,"(GMT -9:00) Alaska"],[-8,"(GMT -8:00) Pacific Time (US & Canada)"],[-7,"(GMT -7:00) Mountain Time (US & Canada)"],[-6,"(GMT -6:00) Central Time (US & Canada), Mexico City"],[-5,"(GMT -5:00) Eastern Time (US & Canada), Bogota, Lima"],[-4,"(GMT -4:00) Atlantic Time (Canada), Caracas, La Paz"],[-3.3,"(GMT -3:30) Newfoundland"],[-3,"(GMT -3:00) Brazil, Buenos Aires, Georgetown"],[-2,"(GMT -2:00) Mid-Atlantic"],[-1,"(GMT -1:00) Azores, Cape Verde Islands"],[0,"(GMT +0:00) Western Europe Time, London, Lisbon, Casablanca"],[1,"(GMT +1:00) Brussels, Copenhagen, Madrid, Paris"],[2,"(GMT +2:00) Kaliningrad, South Africa"],[3,"(GMT +3:00) Яшалта, Moscow, St. Petersburg, Baghdad, Riyadh"],[3.3,"(GMT +3:30) Tehran"],[4,"(GMT +4:00) Abu Dhabi, Muscat, Baku, Tbilisi"],[4.3,"(GMT +4:30) Kabul"],[5,"(GMT +5:00) Ekaterinburg, Islamabad, Karachi, Tashkent"],[5.3,"(GMT +5:30) Bombay, Calcutta, Madras, New Delhi"],[5.45,"(GMT +5:45) Kathmandu"],[6,"(GMT +6:00) Almaty, Dhaka, Colombo"],[7,"(GMT +7:00) Bangkok, Hanoi, Jakarta"],[8,"(GMT +8:00) Beijing, Perth, Singapore, Hong Kong"],[9,"(GMT +9:00) Tokyo, Seoul, Osaka, Sapporo, Yakutsk"],[9.3,"(GMT +9:30) Adelaide, Darwin"],[10,"(GMT +10:00) Eastern Australia, Guam, Vladivostok"],[11,"(GMT +11:00) Magadan, Solomon Islands, New Caledonia"],[12,"(GMT +12:00) Auckland, Wellington, Fiji, Kamchatka"]],_e=/^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/,ve=/^(255|254|252|248|240|224|192|128|0)\.(255|254|252|248|240|224|192|128|0)\.(255|254|252|248|240|224|192|128|0)\.(255|254|252|248|240|224|192|128|0)$/,ce=$t=>{if(!$t)return{date:"",time:""};const se=$t.match(/d:(\d{1,2}\.\d{1,2}\.\d{2})/),ie=$t.match(/t:(\d{2}:\d{2}:\d{2})/);return{date:se?se[1]:"",time:ie?ie[1]:""}},Ee=$t=>{if(!/^\d{1,2}\.\d{1,2}\.\d{2}$/.test($t))return!1;const[ie,ke,Ie]=$t.split(".").map(Number);if(ke<1||ke>12||ie<1||ie>31||Ie<0||Ie>99)return!1;const Oe=new Date().getFullYear()%100;if(Ie>Oe+5)return!1;const Ne=new Date(2e3+Ie,ke,0).getDate();return!(ie>Ne)},te=$t=>!!/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]$/.test($t),ae=($t,se)=>{const ie=Object.values(se).some(Ie=>Ie!==null),ke=$t.usehttps?$t.domain&&$t.domain.trim()!=="":!0;return!(ie||!ke)},mt=($t,se)=>{le({message:$t,type:se}),setTimeout(()=>{le(null)},3e3)},ee=$t=>{Zt($t),setTimeout(()=>{Zt(null)},3e3)},Xt=($t,se)=>{let ie=null;if(!$.usehttps&&["domain","tls_key","tls_cert","tls_ca","telegram_token"].includes($t))return null;if(!se&&["ip_addr","gateway","mqtt_hst","sb_mask","offdate","offtime","domain"].includes($t))return"Поле не может быть пустым";switch($t){case"ip_addr":case"gateway":case"mqtt_hst":_e.test(se)||(ie="Неверный IP-адрес");break;case"sb_mask":ve.test(se)||(ie="Неверная маска подсети");break;case"offdate":Ee(se)||(ie="Неверный формат даты (д.м.гг)");break;case"offtime":te(se)||(ie="Неверный формат времени (чч:мм:сс)");break;case"domain":se.length>50?ie="Домен не должен превышать 50 символов":se.match(/^[a-zA-Z0-9]([a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(\.[a-zA-Z0-9]([a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*\.[a-zA-Z]{2,}$/)||(ie="Неверный формат домена");break;case"tls_key":se&&se.trim()!==""&&(se.length>512?ie="Private Key не должен превышать 512 символов":(!se.includes("BEGIN EC PRIVATE KEY")||!se.includes("END EC PRIVATE KEY"))&&(ie="Неверный формат Private Key"));break;case"tls_cert":se&&se.trim()!==""&&(se.length>1024?ie="Public Key не должен превышать 1024 символов":(!se.includes("BEGIN CERTIFICATE")||!se.includes("END CERTIFICATE"))&&(ie="Неверный формат Public Key"));break;case"tls_ca":se&&se.trim()!==""&&(se.length>1024?ie="Secret Key не должен превышать 1024 символов":(!se.includes("BEGIN CERTIFICATE")||!se.includes("END CERTIFICATE"))&&(ie="Неверный формат Secret Key"));break}return ie},de=$t=>{$t.preventDefault();const se=new FormData(vt.current);let ie={...$};for(const[ke,Ie]of se.entries())["lon_de","lat_de","timezone","mqtt_prt"].includes(ke)?ie[ke]=Ie===""||Ie===null?0:Number(Ie):ie[ke]=Ie;ie.usehttps||["tls_ca","tls_key","tls_cert","telegram_token","domain"].forEach(Ie=>{delete ie[Ie]}),ie.offdate&&ie.offtime?ie.offldt=`d:${ie.offdate} t:${ie.offtime}`:delete ie.offldt,["lon_de","lat_de","timezone","mqtt_prt"].forEach(ke=>{(ie[ke]===null||ie[ke]==="")&&(ie[ke]=0)}),ie.onsunrise=ie.onsunrise?1:0,ie.onsunset=ie.onsunset?1:0,ie.check_ip=ie.check_ip?1:0,ie.check_mqtt=ie.check_mqtt?1:0,ie.usehttps=ie.usehttps?1:0,fetch("/api/mysett/set",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(ie)}).then(ke=>{if(!ke.ok)throw new Error("Ошибка сети или сервера");return ke.json()}).then(ke=>{st("success"),dt(ke),mt("Данные успешно сохранены","success"),ee("Данные успешно сохранены")}).catch(ke=>{st("error"),dt(ke),mt("Ошибка при сохранении данных","error"),ee("Ошибка при сохранении данных")})},be=($t,se)=>{let ie=null;$t==="offdate"?ie=Ee(se)?null:"Неверный формат даты (д.м.гг)":$t==="offtime"?ie=te(se)?null:"Неверный формат времени (чч:мм:сс)":ie=Xt($t,se),Yt(Ie=>{const Oe={...Ie,[$t]:ie},Ne=["tls_key","tls_cert","tls_ca"],Me=Object.keys(Oe).filter(Pe=>!Ne.includes(Pe)&&Pe!=="telegram_token").some(Pe=>Oe[Pe]!==null);return he(Me||!$.usehttps&&Ne.some(Pe=>$[Pe])),Oe});let ke=se;["lon_de","lat_de","timezone","mqtt_prt"].includes($t)?ke=se===""||se===null?0:Number(se):["onsunrise","onsunset","check_ip","check_mqtt","usehttps"].includes($t)&&(ke=se?1:0),_(Ie=>({...Ie,[$t]:ke})),$t==="usehttps"&&(Yt({}),he(!1))},Ce=()=>fetch("/api/mysett/get").then($t=>$t.json()).then($t=>{if($t.offldt){const{date:se,time:ie}=ce($t.offldt);$t.offdate=se,$t.offtime=ie}console.log("Loaded settings:",$t),_($t)}).catch($t=>{console.error("Error fetching settings:",$t),mt("Ошибка при загрузке настроек","error")});return lt(()=>{Ce().then(()=>{$!=null&&$.tls_key&&ge(!0),$!=null&&$.tls_cert&&me(!0),$!=null&&$.tls_ca&&$e(!0),$!=null&&$.telegram_token&&ye(!0),Te(!1)})},[]),lt(()=>{const $t=ae($,pt);he(!$t)},[$,pt]),we?Et`<div>Loading...</div>`:$?(Object.values(pt).some($t=>$t!==null),Et`
      ...
      <div class="flex flex-col items-center w-full p-6 bg-white/40 backdrop-blur-md rounded-2xl shadow-xl border border-white/50">
        ...
        <div class="w-full mb-6 overflow-hidden rounded-2xl shadow-lg border border-white/50 bg-white/30 backdrop-blur-sm">
          <div class="bg-teal-600/10 border-b border-slate-500 px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <select
              value=${$.lang}
              onChange=${$t=>be("lang",$t.target.value)}
            ...
            >
              ${Se.map($t=>Et`<option value=${$t.value}>${$t.label}</option>`)}
            </select>
          </div>
        </div>
        ...
        >
          ...
          <div class="w-full border border-slate-500 bg-white/30 backdrop-blur-sm">
            ...
            <div class="flex flex-col divide-y divide-slate-500">
                  ${[{label:"Login",key:"adm_name",type:"text"},{label:"Password",key:"adm_pswd",type:"password"},{label:"Time zone UTC",key:"timezone",type:"select",options:pe}].map(($t,se)=>Et`
                    <div class="flex flex-col md:flex-row md:items-center px-6 py-2 transition-colors ${se%2===0?"bg-white/80":"bg-sky-200/40"} hover:bg-slate-200/80 gap-2 md:gap-0">
          ...
          <div class="w-full border border-slate-500 bg-white/30 backdrop-blur-sm">
            ...
            ${$.check_mqtt?Et`
              <div class="flex flex-col divide-y divide-slate-500">
                    ${[{label:"Host",key:"mqtt_hst",type:"text"},{label:"Port",key:"mqtt_prt",type:"number"},{label:"Client",key:"mqtt_clt",type:"text"},{label:"User",key:"mqtt_usr",type:"text"},{label:"Password",key:"mqtt_pswd",type:"password"},{label:"TX topic",key:"txmqttop",type:"text"},{label:"RX topic",key:"rxmqttop",type:"text"}].map(($t,se)=>Et`
                      <div class="flex flex-col md:flex-row md:items-center px-6 py-2 transition-colors ${se%2===0?"bg-sky-200/40":"bg-white/80"} hover:bg-slate-200/80 gap-2 md:gap-0">
                        <div class="w-full md:w-1/3 text-lg font-bold text-slate-700 md:pr-4 drop-shadow-sm pl-2 border-r border-slate-500 py-2">
                          ${$t.label}
                        </div>
                        <div class="w-full md:w-2/3 pl-4">
                        ...
                        <div class="w-full md:w-2/3 flex items-start md:items-center">
                          <div class="relative w-full">
                            ${$t.type==="textarea"?Et`
                                ${$t.key==="tls_key"&&$.tls_key?Et`<div class="w-full px-3 py-2 bg-white/40 border border-white/50 rounded-lg text-slate-600 font-medium shadow-inner">Данные введены, но информация скрыта!</div>`:$t.key==="tls_cert"&&$.tls_cert?Et`<div class="w-full px-3 py-2 bg-white/40 border border-white/50 rounded-lg text-slate-600 font-medium shadow-inner">Данные введены успешно!</div>`:Et`<textarea
                                          name=${$t.key}
                                          value=${$[$t.key]||""}
                                          onInput=${ie=>be($t.key,ie.target.value)}
                                          class=${`w-full px-3 py-2 bg-white/50 border ${pt[$t.key]?"border-red-500 ring-2 ring-red-500/50":"border-white/50"} rounded-lg shadow-inner focus:outline-none focus:ring-2 focus:ring-cyan-500`}
                                          rows="1"
                          ...
                          ${$[$t.key]&&$t.key==="tls_cert"&&Et`
                            <div class="absolute right-0 top-0 mt-[3px] mr-[3px] flex gap-2">
                              <button
                                type="button"
                                onClick=${()=>{navigator.clipboard.writeText($[$t.key]),Zt("Данные скопированы"),setTimeout(()=>Zt(""),3e3)}}
                          ...
                          ${pt[$t.key]&&Et`
                            <div class="text-red-500 text-sm mt-1 font-semibold w-full text-left">${pt[$t.key]}</div>
                          `}
                        </div>
                      </div>
                    `)}
          ...
          <div class="w-full border border-slate-500 bg-white/30 backdrop-blur-sm">
            ...
            <div class="flex flex-col divide-y divide-slate-500">
                  <div class="flex flex-col md:flex-row md:items-center px-6 py-2 transition-colors bg-white/80 hover:bg-slate-200/80 gap-2 md:gap-0">
                    ...
                    <div class="w-full md:w-2/3 pl-4">
                      <${pageSetting} value=${$.lon_de} setfn=${$t=>be("lon_de",$t)} type="text" class=${`w-full px-3 py-2 bg-white/50 border ${pt.lon_de?"border-red-500 ring-2 ring-red-500/50":"border-white/50"} rounded-lg shadow-inner focus:outline-none focus:ring-2 focus:ring-cyan-500`} error=${pt.lon_de} />
                    </div>
                  </div>
                  <div class="flex flex-col md:flex-row md:items-center px-6 py-2 transition-colors bg-sky-200/40 hover:bg-slate-200/80 gap-2 md:gap-0">
                    ...
                    <div class="w-full md:w-2/3 pl-4">
                      <${pageSetting} value=${$.lat_de} setfn=${$t=>be("lat_de",$t)} type="text" class=${`w-full px-3 py-2 bg-white/50 border ${pt.lat_de?"border-red-500 ring-2 ring-red-500/50":"border-white/50"} rounded-lg shadow-inner focus:outline-none focus:ring-2 focus:ring-cyan-500`} error=${pt.lat_de} />
                    </div>
                  </div>
                  <div class="flex flex-col md:flex-row md:items-center px-6 py-2 transition-colors bg-white/80 hover:bg-slate-200/80 gap-2 md:gap-0">
                    <div class="w-full md:w-1/3 text-lg font-bold text-slate-700 md:pr-4 drop-shadow-sm pl-2 border-r border-slate-500 py-2">
                    ...
                    <div class="w-full md:w-2/3 flex items-center gap-4">
                      <${MyPolzunok} value=${$.onsunrise} onChange=${$t=>be("onsunrise",$t)} />
                      <input
                        type="text"
                        value=${$.sunrise_pins||""}
                        onInput=${$t=>be("sunrise_pins",$t.target.value)}
                        maxlength="20"
                  ...
                  <div class="flex flex-col md:flex-row md:items-center px-6 py-2 transition-colors bg-sky-200/40 hover:bg-slate-200/80 gap-2 md:gap-0">
                    ...
                    <div class="w-full md:w-2/3 flex items-center gap-4">
                      <${MyPolzunok} value=${$.onsunset} onChange=${$t=>be("onsunset",$t)} />
                      <input
                        type="text"
                        value=${$.sunset_pins||""}
                        onInput=${$t=>be("sunset_pins",$t.target.value)}
                        maxlength="20"
              ...
              <div class="flex-1 flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-4 hover:bg-slate-200/80 transition-colors">
                ...
                <div class="flex-grow flex flex-col w-full pr-4">
                  <input
                    ...
                    name="offdate"
                    value=${$.offdate||""}
                    onInput=${$t=>be("offdate",$t.target.value)}
              ...
              <div class="flex-1 flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-4 hover:bg-slate-200/80 transition-colors">
                ...
                <div class="flex-grow flex flex-col w-full pr-4">
                  <input
                    ...
                    name="offtime"
                    value=${$.offtime||""}
                    onInput=${$t=>be("offtime",$t.target.value)}
  ...
  </svg>`;function Header({logout:$,user:_,setShowSidebar:k,showSidebar:dt}){const[ct,st]=ut(new Date),[pt,Yt]=ut(null),vt=(Zt,ne)=>new Date(Zt.year+1900,Zt.mon,Zt.mday,Zt.hour,Zt.min,Zt.sec),oe=async()=>{try{const ne=await(await fetch("/api/stm32-time")).text();let he;try{he=JSON.parse(ne)}catch{return}he.status&&he.time?Yt(vt(he.time,he.timezone)):Yt(null)}catch{Yt(null)}};lt(()=>{const Zt=setInterval(()=>st(new Date),1e3),ne=setInterval(oe,1e3);return oe(),()=>{clearInterval(Zt),clearInterval(ne)}},[]);const le=Zt=>Zt.toLocaleDateString("ru-RU",{day:"2-digit",month:"2-digit",year:"numeric"}),ht=Zt=>Zt.toLocaleTimeString("ru-RU");return Et`
    <div
...
/>
  ...
  <//>`}function Chart({data:$}){const _=$.length,k=20,dt=15,ct=100,st=5,pt=10,Yt=25,vt=Zt=>(ct-pt)/st*(Zt+1),oe=Zt=>(ct-pt)*Zt/100,le=Zt=>ct-pt-oe(Zt),ht=(Zt,ne,he)=>Array.from({length:ne},(xe,ge)=>ge*1+Zt);return Et` <div
    ...
    <div class="relative">
      <svg class="bg-yellow-x50 w-full p-4" viewBox="0 0 ${_*k+dt} ${ct}">
        ${ht(0,st).map(Zt=>Et`
            ...
            />
            <text x="0" y=${vt(Zt)-2} class="text-[6px] fill-slate-400"
              >${Yt-Yt/st*(Zt+1)}<//
            >
          `)}
        ${ht(0,_).map(Zt=>Et`
  ...
  `}function FirmwareUpdate({}){const[$,_]=ut([{},{}]),[k,dt]=ut(null),ct=()=>fetch("api/firmware/status").then(Zt=>Zt.json()).then(Zt=>_(Zt));lt(ct,[]),lt(()=>{if(k){const Zt=setTimeout(()=>{dt(null)},3e3);return()=>clearTimeout(Zt)}},[k]);const st=Zt=>fetch("api/firmware/commit").then(ne=>ne.json()).then(ct),pt=Zt=>fetch("api/reboot",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({reboot:1})}).then(ne=>ne.json()).then(ne=>new Promise(he=>setTimeout(()=>{ct(),he()},5e3))),Yt=Zt=>fetch("api/firmware/rollback").then(pt),vt=Zt=>fetch("api/device/eraselast").then(ct),oe=function(Zt){if(!Zt){dt({type:"yellow",message:"Error: No file selected."});return}const ne=Zt.name.split(".").pop().toLowerCase();if(ne!=="bin"&&ne!=="hex"){dt({type:"red",message:"Error: Only .bin and .hex files are allowed!"});return}const he=new FormData;he.append("file",Zt),fetch("api/firmware/upload",{method:"POST",body:he}).then(xe=>{if(!xe.ok)throw new Error(`HTTP error! status: ${xe.status}`);return xe.json()}).then(()=>{dt({type:"green",message:"Firmware uploaded successfully!"}),ct()}).catch(xe=>{dt({type:"yellow",message:`Error: Upload failed. ${xe.message}`})})},le=({type:Zt,message:ne})=>Et`
      <div
    ...
    `,ht=({title:Zt,onupload:ne})=>Et`
      ...
      >
        ...
        <input
          ...
          class="hidden"
          accept=".bin,.hex"
          onChange=${xe=>{const ge=xe.target.files[0];ge&&ne(ge)}}
        />
      </label>
    `;return Et`
  ...
  `}const pageSetting=({value:$,setfn:_,type:k,options:dt,error:ct,...st})=>{let pt;const Yt=`w-full px-3 py-2 border rounded-md ${ct?"border-red-500":"border-gray-300"}`;switch(k){case"text":case"password":case"number":pt=Et`
      ...
      `;break;case"select":pt=Et`
        <select
          ...
          ...${st}
        >
          ${dt.map(([vt,oe])=>Et` <option value=${vt}>${oe}</option> `)}
        </select>
  ...
  `},App=function({}){const[$,_]=ut(!0),[k,dt]=ut("/"),[ct,st]=ut(""),[pt,Yt]=ut(!0),vt=()=>fetch("api/logout").then(le=>st("")),oe=le=>le.ok?le.json().then(ht=>st(ht.user)).finally(ht=>_(!1)):_(!1)&&st(null);return lt(()=>fetch("api/login").then(oe),[]),$?"":ct?Et` <div class="min-h-screen bg-slate-100" id="mains">
